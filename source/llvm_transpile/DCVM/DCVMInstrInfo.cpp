...
namespace llvm {
    ...
    bool DCVMInstrInfo::analyzeBranch(MachineBasicBlock &MBB,
    ...
    unsigned DCVMInstrInfo::insertBranch(MachineBasicBlock &MBB,
                                         MachineBasicBlock *TBB,
                                         MachineBasicBlock *FBB,
    ...
    unsigned DCVMInstrInfo::removeBranch(MachineBasicBlock &MBB,
    ...
    bool DCVMInstrInfo::reverseBranchCondition(
        SmallVectorImpl<MachineOperand> &Cond) const {
        assert(Cond.size() == 2 && "invalid branch condition");
        Cond[0].setImm(Cond[0].getImm() == DCVM::BRANCHIF ? DCVM::BRANCHIFNOT
                                                          : DCVM::BRANCHIF);
        return false;
    }
} // namespace llvm
