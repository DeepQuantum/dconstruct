...
bb0:
  ...
  %__Call_19___call51 = tail call i64 %"__LookupPointer_is-script-running?_fptr"(i64 6150028017864311825), !callees !2
...
bb2:                                              ; preds = %bb0, %bb2
  ...
  %"__LookupPointer_is-script-running?_fptr53" = call ptr @llvm.dcvm.lookup(i64 6481843155139167450)
  %__Call_19___call = tail call i64 %"__LookupPointer_is-script-running?_fptr53"(i64 6150028017864311825), !callees !2
  %1 = trunc i64 %__Call_19___call to i1
  br i1 %1, label %bb3, label %bb2

bb3:                                              ; preds = %bb2, %bb0
  %__LookupPointer_new-boxed-value_fptr54 = call ptr @llvm.dcvm.lookup(i64 3684810824690217768)
  %__CallFf_33___call = tail call i64 %__LookupPointer_new-boxed-value_fptr54(i64 7, i64 %arg_0), !callees !0
...
bb6.preheader:                                    ; preds = %bb4, %bb5
  ...
  %__Call_56___call52 = tail call i64 %"__LookupPointer_is-script-running?_fptr55"(i64 6150028017864311825), !callees !2
  %2 = trunc i64 %__Call_56___call52 to i1
  br i1 %2, label %bb8, label %bb7

bb7:                                              ; preds = %bb6.preheader, %bb7
  %__LookupPointer_wait-one-frame_fptr56 = call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  %__CallFf_60___call = tail call i64 %__LookupPointer_wait-one-frame_fptr56(), !callees !3
  %"__LookupPointer_is-script-running?_fptr57" = call ptr @llvm.dcvm.lookup(i64 6481843155139167450)
  %__Call_56___call = tail call i64 %"__LookupPointer_is-script-running?_fptr57"(i64 6150028017864311825), !callees !2
...
bb0:
  ...
  %__Call_21___call = tail call i64 %__LookupPointer_wait-until-in-valid-gas-mask-state_fptr(i64 %arg_0, i64 %__LoadU8_18___ext), !callees !18
...
bb3:                                              ; preds = %bb0, %bb1
  ...
  %__CallFf_58___call = tail call i64 %__LookupPointer_set-high-contrast-mode-type_fptr(i64 %r1.0, i64 6), !callees !20
...
bb4:                                              ; preds = %bb3
  ...
  %__CallFf_69___call = tail call i64 %__LookupPointer_set-instance-flag-hero_fptr(i64 %r1.0, i64 1), !callees !22
  %__LookupPointer_set-show-in-flashlight-flag_fptr = call ptr @llvm.dcvm.lookup(i64 -7252477440030364545)
  %__CallFf_75___call = tail call i64 %__LookupPointer_set-show-in-flashlight-flag_fptr(i64 %r1.0, i64 0), !callees !23
  br label %bb6

bb5:                                              ; preds = %bb3
  %__LookupPointer_set-shadow-casting-from-npc-flashlight_fptr = call ptr @llvm.dcvm.lookup(i64 -3854484060414110792)
  %__CallFf_82___call = tail call i64 %__LookupPointer_set-shadow-casting-from-npc-flashlight_fptr(i64 %r1.0, i64 0), !callees !24
  br label %bb6

bb6:                                              ; preds = %bb5, %bb4
  %__LookupPointer_set-gas-mask_fptr = call ptr @llvm.dcvm.lookup(i64 -5971891483814290574)
  %__CallFf_88___call = tail call i64 %__LookupPointer_set-gas-mask_fptr(i64 %arg_0, i64 %r1.0), !callees !25
  %__LookupPointer_set-visible_fptr = call ptr @llvm.dcvm.lookup(i64 -7746349783173232884)
  %__CallFf_94___call = tail call i64 %__LookupPointer_set-visible_fptr(i64 %r1.0, i64 0), !callees !26
  %"__LookupPointer_is-player?_fptr186" = call ptr @llvm.dcvm.lookup(i64 6532480022340268902)
  %__CallFf_98___call = tail call i64 %"__LookupPointer_is-player?_fptr186"(i64 %arg_0), !callees !21
...
bb7:                                              ; preds = %bb6
  ...
  %__CallFf_102___call = tail call i64 %__LookupPointer_wait-one-frame_fptr187(), !callees !3
  br label %bb9

bb9:                                              ; preds = %bb6, %bb7
  %__LookupPointer_attach_fptr = call ptr @llvm.dcvm.lookup(i64 -5676660224586178492)
  %__CallFf_114___call = tail call i64 %__LookupPointer_attach_fptr(i64 %r1.0, i64 %arg_0, i64 8667864169316382944, float 0.000000e+00), !callees !27
  ...
  %__CallFf_149___call = tail call i64 %__LookupPointer_animate__fptr(i64 %r1.0, i64 %__LoadU64_133___load, i64 %__CallFf_143___call), !callees !29
  br label %bb10
...
bb10:                                             ; preds = %bb11, %bb9
  ...
  %__CallFf_156___call = tail call i64 %__LookupPointer_alloc-gesture-play-params_fptr(), !callees !30
  ...
  %__CallFf_178___call = tail call i64 %__LookupPointer_gesture__fptr(i64 %arg_0, i64 %__LoadU64_154___load, i64 %__CallFf_156___call), !callees !31
...
bb11:                                             ; preds = %bb10
  ...
  %__CallFf_184___call = tail call i64 %__LookupPointer_wait-one-frame_fptr188(), !callees !3
  br label %bb10
...
bb12:                                             ; preds = %bb10
  ...
  %__CallFf_201___call = tail call i64 %"__LookupPointer_#%alloc-array_fptr189"(i64 8534565298598421705, i64 16, i64 0, i64 1), !callees !28
  %__LookupPointer_animate__fptr190 = call ptr @llvm.dcvm.lookup(i64 -9179819928081802467)
  %__CallFf_207___call = tail call i64 %__LookupPointer_animate__fptr190(i64 %r1.0, i64 %__LoadU64_191___load, i64 %__CallFf_201___call), !callees !29
  ret i64 %__CallFf_207___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !32 i64 @lookup-symbol(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !33 i64 @get-gas-mask-setting-id(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !34 i64 @wait-until-in-valid-gas-mask-state(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !35 i64 @spawn-object(i64, i64, i64, i64, i64, i64, i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !36 i64 @set-high-contrast-mode-type(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !37 i64 @"is-player?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !38 i64 @set-instance-flag-hero(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !39 i64 @set-show-in-flashlight-flag(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !40 i64 @set-shadow-casting-from-npc-flashlight(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !41 i64 @set-gas-mask(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !42 i64 @set-visible(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !43 i64 @attach(i64, i64, i64, float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !44 i64 @animate_(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !45 i64 @"#%alloc-array"(i64, i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !46 i64 @gesture_(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !47 i64 @alloc-gesture-play-params() local_unnamed_addr #1
...
bb3:                                              ; preds = %bb0, %bb1
  ...
  %__LookupPointer_set-high-contrast-mode-type_fptr = call ptr @llvm.dcvm.lookup(i64 4766017279285775524)
  %__CallFf_47___call = tail call i64 %__LookupPointer_set-high-contrast-mode-type_fptr(i64 %r1.0, i64 6), !callees !20
  %__LookupPointer_set-gas-mask_fptr = call ptr @llvm.dcvm.lookup(i64 -5971891483814290574)
  %__CallFf_53___call = tail call i64 %__LookupPointer_set-gas-mask_fptr(i64 %arg_0, i64 %r1.0), !callees !25
  %"__LookupPointer_is-player?_fptr" = call ptr @llvm.dcvm.lookup(i64 6532480022340268902)
...
bb4:                                              ; preds = %bb3
  ...
  %__LookupPointer_set-instance-flag-hero_fptr = call ptr @llvm.dcvm.lookup(i64 -429226074377614887)
  %__CallFf_77___call = tail call i64 %__LookupPointer_set-instance-flag-hero_fptr(i64 %r1.0, i64 1), !callees !22
  br label %bb6

bb6:                                              ; preds = %bb3, %bb4
  %__CallFf_85___call = tail call i64 (i64, i64, ...) @send-event(i64 1827492438953869695, i64 %arg_0)
  %"__LookupPointer_is-player?_fptr148" = call ptr @llvm.dcvm.lookup(i64 6532480022340268902)
  %__CallFf_89___call = tail call i64 %"__LookupPointer_is-player?_fptr148"(i64 %arg_0), !callees !21
  %__BranchIfNot_90___bool.not = icmp eq i64 %__CallFf_89___call, 0
  br i1 %__BranchIfNot_90___bool.not, label %bb8, label %bb7

bb7:                                              ; preds = %bb6
  %__LookupPointer_set-show-in-flashlight-flag_fptr = call ptr @llvm.dcvm.lookup(i64 -7252477440030364545)
  %__CallFf_96___call = tail call i64 %__LookupPointer_set-show-in-flashlight-flag_fptr(i64 %r1.0, i64 0), !callees !23
  br label %bb9

bb8:                                              ; preds = %bb6
  %__LookupPointer_set-shadow-casting-from-npc-flashlight_fptr = call ptr @llvm.dcvm.lookup(i64 -3854484060414110792)
  %__CallFf_103___call = tail call i64 %__LookupPointer_set-shadow-casting-from-npc-flashlight_fptr(i64 %r1.0, i64 0), !callees !24
  br label %bb9
...
bb9:                                              ; preds = %bb8, %bb7
  ...
  %__LookupPointer_animate__fptr = call ptr @llvm.dcvm.lookup(i64 -9179819928081802467)
  %__CallFf_151___call = tail call i64 %__LookupPointer_animate__fptr(i64 %r1.0, i64 %__LoadU64_109___load, i64 %__CallFf_119___call), !callees !29
...
bb1:                                              ; preds = %bb0, %bb3
  ...
  %__CallFf_10___call = tail call i64 %"__LookupPointer_player-in-state?_fptr"(i64 6740565536053766520), !callees !48
  %0 = trunc i64 %__CallFf_10___call to i1
  br i1 %0, label %bb3, label %bb2

bb2:                                              ; preds = %bb1
  %"__LookupPointer_player-in-state?_fptr76" = call ptr @llvm.dcvm.lookup(i64 -9003251364961024783)
  %__CallFf_16___call = tail call i64 %"__LookupPointer_player-in-state?_fptr76"(i64 2237451099064635199), !callees !48
...
bb5:                                              ; preds = %bb4
  ...
  %__CallFf_26___call = tail call i64 %__LookupPointer_player-force-crouch_fptr(), !callees !49
  %"__LookupPointer_player-is-crouched?_fptr" = call ptr @llvm.dcvm.lookup(i64 1646463116072042322)
  %__CallFf_28___call66 = tail call i64 %"__LookupPointer_player-is-crouched?_fptr"(), !callees !50
  %2 = trunc i64 %__CallFf_28___call66 to i1
  br i1 %2, label %bb12.preheader, label %bb7

bb12.preheader:                                   ; preds = %bb7, %bb11, %bb5, %bb9
  %"__LookupPointer_player-in-state?_fptr77" = call ptr @llvm.dcvm.lookup(i64 -9003251364961024783)
  %__CallFf_50___call69 = tail call i64 %"__LookupPointer_player-in-state?_fptr77"(i64 4007104907368024212), !callees !48
...
bb7:                                              ; preds = %bb5, %bb7
  ...
  %__CallFf_32___call = tail call i64 %__LookupPointer_wait-one-frame_fptr78(), !callees !3
  %"__LookupPointer_player-is-crouched?_fptr79" = call ptr @llvm.dcvm.lookup(i64 1646463116072042322)
  %__CallFf_28___call = tail call i64 %"__LookupPointer_player-is-crouched?_fptr79"(), !callees !50
...
bb9:                                              ; preds = %bb4
  ...
  %__CallFf_36___call = tail call i64 %__LookupPointer_player-force-stand_fptr(), !callees !51
  %"__LookupPointer_player-is-crouched?_fptr80" = call ptr @llvm.dcvm.lookup(i64 1646463116072042322)
  %__CallFf_39___call67 = tail call i64 %"__LookupPointer_player-is-crouched?_fptr80"(), !callees !50
  %"__LookupPointer_!_fptr" = call ptr @llvm.dcvm.lookup(i64 -5808627241898115124)
  %__Call_41___call68 = tail call i64 %"__LookupPointer_!_fptr"(i64 %__CallFf_39___call67), !callees !52
...
bb11:                                             ; preds = %bb9, %bb11
  ...
  %__CallFf_45___call = tail call i64 %__LookupPointer_wait-one-frame_fptr81(), !callees !3
  %"__LookupPointer_player-is-crouched?_fptr82" = call ptr @llvm.dcvm.lookup(i64 1646463116072042322)
  %__CallFf_39___call = tail call i64 %"__LookupPointer_player-is-crouched?_fptr82"(), !callees !50
  %"__LookupPointer_!_fptr83" = call ptr @llvm.dcvm.lookup(i64 -5808627241898115124)
  %__Call_41___call = tail call i64 %"__LookupPointer_!_fptr83"(i64 %__CallFf_39___call), !callees !52
...
bb13:                                             ; preds = %bb12.preheader, %bb13
  ...
  %__CallFf_54___call = tail call i64 %__LookupPointer_wait-one-frame_fptr84(), !callees !3
  %"__LookupPointer_player-in-state?_fptr85" = call ptr @llvm.dcvm.lookup(i64 -9003251364961024783)
  %__CallFf_50___call = tail call i64 %"__LookupPointer_player-in-state?_fptr85"(i64 4007104907368024212), !callees !48
...
bb14:                                             ; preds = %bb13, %bb12.preheader
  ...
  %__CallFf_61___call = tail call i64 %__LookupPointer_wait-holster-player-weapon_fptr(i64 0, float 1.000000e+00), !callees !53
  %__LookupPointer_holster-player-weapon-instantly_fptr = call ptr @llvm.dcvm.lookup(i64 -626103520744544694)
  %__CallFf_67___call = tail call i64 %__LookupPointer_holster-player-weapon-instantly_fptr(float 0x3FC99999A0000000, i64 0), !callees !54
  br label %bb21

bb15:                                             ; preds = %bb0
  %__LookupPointer_wait-npc-holster-weapon_fptr = call ptr @llvm.dcvm.lookup(i64 5808793362033684947)
  %__CallFf_80___call = tail call i64 %__LookupPointer_wait-npc-holster-weapon_fptr(i64 %arg_0, i64 0, i64 1, float -1.000000e+00, i64 0), !callees !55
  %"__LookupPointer_npc-has-weapon-in-hand?_fptr" = call ptr @llvm.dcvm.lookup(i64 7683024912818272899)
  %__CallFf_84___call70 = tail call i64 %"__LookupPointer_npc-has-weapon-in-hand?_fptr"(i64 %arg_0), !callees !56
...
bb17:                                             ; preds = %bb15, %bb17
  %__LookupPointer_wait-one-frame_fptr86 = call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  %__CallFf_87___call = tail call i64 %__LookupPointer_wait-one-frame_fptr86(), !callees !3
  %"__LookupPointer_npc-has-weapon-in-hand?_fptr87" = call ptr @llvm.dcvm.lookup(i64 7683024912818272899)
  %__CallFf_84___call = tail call i64 %"__LookupPointer_npc-has-weapon-in-hand?_fptr87"(i64 %arg_0), !callees !56
...
bb19:                                             ; preds = %bb18
  ...
  %__CallFf_96___call = tail call i64 %__LookupPointer_wait-npc-set-demeanor_fptr(i64 %arg_0, i64 3), !callees !57
  br label %bb21
...
; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !58 i64 @"player-in-state?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !59 i64 @player-force-crouch() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !60 i64 @"player-is-crouched?"() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !61 i64 @player-force-stand() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !62 i64 @"!"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !63 i64 @wait-holster-player-weapon(i64, float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !64 i64 @holster-player-weapon-instantly(float, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !65 i64 @wait-npc-holster-weapon(i64, i64, i64, float, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !66 i64 @"npc-has-weapon-in-hand?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !67 i64 @wait-npc-set-demeanor(i64, i64) local_unnamed_addr #1
...
bb0:
  ...
  %__Call_10___call = tail call i64 %"__LookupPointer_suspend-idle-gestures/f_fptr"(i64 %arg_0), !callees !68
  %__LookupPointer_npc-disable-dialog-look_fptr = call ptr @llvm.dcvm.lookup(i64 7610916627332680768)
  %__CallFf_16___call = tail call i64 %__LookupPointer_npc-disable-dialog-look_fptr(i64 %arg_0, float 0.000000e+00), !callees !69
  ret i64 %__CallFf_16___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !70 i64 @"suspend-idle-gestures/f"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !71 i64 @npc-disable-dialog-look(i64, float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @internal-put-off-gas-mask-immediately(i64 %arg_0, i64 %arg_1) local_unnamed_addr #1 !dcvm.sid_distance !72 {
bb0:
  %__LookupPointer_get-gas-mask_fptr = call ptr @llvm.dcvm.lookup(i64 -5076200561558624898)
...
bb1:                                              ; preds = %bb0
  ...
  %__CallFf_17___call = tail call i64 %__LookupPointer_kill-entity_fptr(i64 %__CallFf_5___call), !callees !73
  br label %bb3
...
; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !74 i64 @kill-entity(i64) local_unnamed_addr #1
...
bb0:
  ...
  %__CallFf_6___call = tail call i64 %__LookupPointer_player-disable-dialog-look-gestures_fptr(float 0.000000e+00), !callees !75
  %"__LookupPointer_player-disable-squeeze-through/f_fptr" = call ptr @llvm.dcvm.lookup(i64 8165897991486741957)
  %__CallFf_8___call = tail call i64 %"__LookupPointer_player-disable-squeeze-through/f_fptr"(), !callees !76
  %"__LookupPointer_player-set-narrative-mode/f_fptr" = call ptr @llvm.dcvm.lookup(i64 -2826777519175913837)
  %__Call_16___call = tail call i64 %"__LookupPointer_player-set-narrative-mode/f_fptr"(i64 %arg_0, i64 %arg_1, i64 %arg_2), !callees !77
  %"__LookupPointer_suspend-idle-gestures/f_fptr" = call ptr @llvm.dcvm.lookup(i64 -5356689657310757786)
  %__Call_20___call = tail call i64 %"__LookupPointer_suspend-idle-gestures/f_fptr"(i64 5008278420455340480), !callees !68
  %__LookupPointer_joypad-disable-commands_fptr = call ptr @llvm.dcvm.lookup(i64 7121253686161376880)
  %__CallFf_24___call = tail call i64 %__LookupPointer_joypad-disable-commands_fptr(i64 -1699981380503476753), !callees !78
  ret i64 %__CallFf_24___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !79 i64 @player-disable-dialog-look-gestures(float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !80 i64 @"player-disable-squeeze-through/f"() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !81 i64 @"player-set-narrative-mode/f"(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !82 i64 @joypad-disable-commands(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @internal-put-off-gas-mask(i64 %arg_0, i64 %arg_1) local_unnamed_addr #1 !dcvm.sid_distance !83 {
bb0:
  %__LookupPointer_wait-one-frame_fptr = call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  %__CallFf_3___call = tail call i64 %__LookupPointer_wait-one-frame_fptr(), !callees !3
  %__LookupPointer_get-gas-mask-setting-id_fptr = call ptr @llvm.dcvm.lookup(i64 -6573555005595409285)
  ...
  %__LookupPointer_animate__fptr = call ptr @llvm.dcvm.lookup(i64 -9179819928081802467)
  %__CallFf_47___call = tail call i64 %__LookupPointer_animate__fptr(i64 %__CallFf_16___call, i64 %__LoadU64_31___load, i64 %__CallFf_41___call), !callees !29
...
bb1:                                              ; preds = %bb2, %bb0
  ...
  %__LookupPointer_alloc-gesture-play-params_fptr = call ptr @llvm.dcvm.lookup(i64 -2962780980939953026)
  %__CallFf_55___call = tail call i64 %__LookupPointer_alloc-gesture-play-params_fptr(), !callees !30
  ...
  store i8 1, ptr %4, align 1
  %__LookupPointer_gesture__fptr = call ptr @llvm.dcvm.lookup(i64 6500315221283771953)
  %__CallFf_77___call = tail call i64 %__LookupPointer_gesture__fptr(i64 %arg_0, i64 %__LoadU64_53___load, i64 %__CallFf_55___call), !callees !31
  %__IEqual_79__op.not = icmp eq i64 %__CallFf_77___call, 0
  br i1 %__IEqual_79__op.not, label %bb3, label %bb2

bb2:                                              ; preds = %bb1
  %__LookupPointer_wait-one-frame_fptr78 = call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  %__CallFf_83___call = tail call i64 %__LookupPointer_wait-one-frame_fptr78(), !callees !3
  br label %bb1
...
bb4:                                              ; preds = %bb3
  %__LookupPointer_kill-entity_fptr = call ptr @llvm.dcvm.lookup(i64 -804116741684351865)
  %__CallFf_90___call = tail call i64 %__LookupPointer_kill-entity_fptr(i64 %__CallFf_16___call), !callees !73
  br label %bb6
...
bb0:
  ...
  %__CallFf_15___call = tail call i64 %__LookupPointer_fact-set_fptr(i64 %arg_0, i64 7671589888336862994, i64 %__CallFf_11___call), !callees !1
  %"__LookupPointer_is-script-running?_fptr" = call ptr @llvm.dcvm.lookup(i64 6481843155139167450)
  %__Call_19___call41 = tail call i64 %"__LookupPointer_is-script-running?_fptr"(i64 6150028017864311825), !callees !2
...
bb2:                                              ; preds = %bb0, %bb2
  %__LookupPointer_wait-one-frame_fptr = call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  %__CallFf_23___call = tail call i64 %__LookupPointer_wait-one-frame_fptr(), !callees !3
  %"__LookupPointer_is-script-running?_fptr42" = call ptr @llvm.dcvm.lookup(i64 6481843155139167450)
  %__Call_19___call = tail call i64 %"__LookupPointer_is-script-running?_fptr42"(i64 6150028017864311825), !callees !2
  %1 = trunc i64 %__Call_19___call to i1
  br i1 %1, label %bb3, label %bb2

bb3:                                              ; preds = %bb2, %bb0
  %__LookupPointer_new-boxed-value_fptr43 = call ptr @llvm.dcvm.lookup(i64 3684810824690217768)
  %__CallFf_33___call = tail call i64 %__LookupPointer_new-boxed-value_fptr43(i64 7, i64 %arg_0), !callees !0
  %__LookupPointer_send-event_fptr = call ptr @llvm.dcvm.lookup(i64 4789555171397753330)
...
bb1.i:                                            ; preds = %bb4
  %__LookupPointer_kill-entity_fptr = call ptr @llvm.dcvm.lookup(i64 -804116741684351865)
  %__CallFf_17___call.i = tail call i64 %__LookupPointer_kill-entity_fptr(i64 %__CallFf_5___call.i), !callees !73
  br label %bb6

bb5:                                              ; preds = %bb3
  %__LookupPointer_internal-put-off-gas-mask_fptr = call ptr @llvm.dcvm.lookup(i64 -6610620527767074061)
  %__Call_52___call = tail call i64 %__LookupPointer_internal-put-off-gas-mask_fptr(i64 %arg_0, i64 %arg_2), !callees !84
  br label %bb6
...
!28 = !{ptr @"#%alloc-array"}
!29 = !{ptr @animate_}
!30 = !{ptr @alloc-gesture-play-params}
!31 = !{ptr @gesture_}
!32 = !{!"sid", i64 -7658033447216601854, !"distance", !"far"}
!33 = !{!"sid", i64 -6573555005595409285, !"distance", !"far"}
!34 = !{!"sid", i64 8203816822361639083, !"distance", !"near"}
!35 = !{!"sid", i64 7097052834867614476, !"distance", !"far"}
!36 = !{!"sid", i64 4766017279285775524, !"distance", !"far"}
!37 = !{!"sid", i64 6532480022340268902, !"distance", !"far"}
!38 = !{!"sid", i64 -429226074377614887, !"distance", !"far"}
!39 = !{!"sid", i64 -7252477440030364545, !"distance", !"far"}
!40 = !{!"sid", i64 -3854484060414110792, !"distance", !"far"}
!41 = !{!"sid", i64 -5971891483814290574, !"distance", !"far"}
!42 = !{!"sid", i64 -7746349783173232884, !"distance", !"far"}
!43 = !{!"sid", i64 -5676660224586178492, !"distance", !"far"}
!44 = !{!"sid", i64 -9179819928081802467, !"distance", !"far"}
!45 = !{!"sid", i64 -7745656483000545638, !"distance", !"far"}
!46 = !{!"sid", i64 6500315221283771953, !"distance", !"far"}
!47 = !{!"sid", i64 -2962780980939953026, !"distance", !"far"}
!48 = !{ptr @"player-in-state?"}
!49 = !{ptr @player-force-crouch}
!50 = !{ptr @"player-is-crouched?"}
!51 = !{ptr @player-force-stand}
!52 = !{ptr @"!"}
!53 = !{ptr @wait-holster-player-weapon}
!54 = !{ptr @holster-player-weapon-instantly}
!55 = !{ptr @wait-npc-holster-weapon}
!56 = !{ptr @"npc-has-weapon-in-hand?"}
!57 = !{ptr @wait-npc-set-demeanor}
!58 = !{!"sid", i64 -9003251364961024783, !"distance", !"far"}
!59 = !{!"sid", i64 -4831287436211302109, !"distance", !"far"}
!60 = !{!"sid", i64 1646463116072042322, !"distance", !"far"}
!61 = !{!"sid", i64 8594926419455150747, !"distance", !"far"}
!62 = !{!"sid", i64 -5808627241898115124, !"distance", !"near"}
!63 = !{!"sid", i64 -3092934816467423265, !"distance", !"far"}
!64 = !{!"sid", i64 -626103520744544694, !"distance", !"far"}
!65 = !{!"sid", i64 5808793362033684947, !"distance", !"far"}
!66 = !{!"sid", i64 7683024912818272899, !"distance", !"far"}
!67 = !{!"sid", i64 8573502661920361253, !"distance", !"far"}
!68 = !{ptr @"suspend-idle-gestures/f"}
!69 = !{ptr @npc-disable-dialog-look}
!70 = !{!"sid", i64 -5356689657310757786, !"distance", !"near"}
!71 = !{!"sid", i64 7610916627332680768, !"distance", !"far"}
!72 = !{!"sid", i64 -8559530813269772124, !"distance", !"near"}
!73 = !{ptr @kill-entity}
!74 = !{!"sid", i64 -804116741684351865, !"distance", !"far"}
!75 = !{ptr @player-disable-dialog-look-gestures}
!76 = !{ptr @"player-disable-squeeze-through/f"}
!77 = !{ptr @"player-set-narrative-mode/f"}
!78 = !{ptr @joypad-disable-commands}
!79 = !{!"sid", i64 7238593933813171071, !"distance", !"far"}
!80 = !{!"sid", i64 8165897991486741957, !"distance", !"far"}
!81 = !{!"sid", i64 -2826777519175913837, !"distance", !"near"}
!82 = !{!"sid", i64 7121253686161376880, !"distance", !"far"}
!83 = !{!"sid", i64 -6610620527767074061, !"distance", !"near"}
!84 = !{ptr @internal-put-off-gas-mask}
