...
bb0:
  %__CallFf_11___call = tail call i64 @new-boxed-value(i64 1, i64 1), !dcvm.distance !1
  %__CallFf_15___call = tail call i64 @fact-set(i64 %arg_0, i64 7671589888336862994, i64 %__CallFf_11___call), !dcvm.distance !1
...
bb2:                                              ; preds = %bb0, %bb2
  %__CallFf_23___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
...
bb3:                                              ; preds = %bb2, %bb0
  %__CallFf_33___call = tail call i64 @new-boxed-value(i64 7, i64 %arg_0), !dcvm.distance !1
  %__CallFf_37___call = tail call i64 @send-event(i64 -3266162430027026367, i64 6150028017864311825, i64 %__CallFf_33___call), !dcvm.distance !1
...
bb6.preheader:                                    ; preds = %bb4, %bb5
  %__Call_56___call53 = tail call i64 @"is-script-running?"(i64 6150028017864311825)
...
bb7:                                              ; preds = %bb6.preheader, %bb7
  %__CallFf_60___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
...
bb8:                                              ; preds = %bb7, %bb6.preheader
  %__CallFf_65___call = tail call i64 @get-gas-mask(i64 %arg_0), !dcvm.distance !1
  ret i64 %__CallFf_65___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !2 i64 @fact-set(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !3 i64 @new-boxed-value(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !4 i64 @"is-script-running?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !5 i64 @wait-one-frame() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !6 i64 @send-event(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !7 i64 @internal-put-on-gas-mask-immediately(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !8 i64 @internal-put-on-gas-mask(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !9 i64 @get-gas-mask(i64) local_unnamed_addr #1

; Function Attrs: nosync nounwind
define i64 @internal-put-on-gas-mask.1(i64 %arg_0, i64 %arg_1) local_unnamed_addr #0 !dcvm.sid_distance !10 {
bb0:
  %__CallFf_3___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  %__CallFf_8___call = tail call i64 @get-gas-mask-setting-id(i64 %arg_0), !dcvm.distance !1
  %__CallFf_12___call = tail call i64 @lookup-symbol(i64 %__CallFf_8___call, i64 3455792245619945009), !dcvm.distance !1
...
bb1:                                              ; preds = %bb0
  ...
  %__CallFf_48___call = tail call i64 @spawn-object(i64 %__LoadU64_30___load, i64 267125575217391726, i64 0, i64 0, i64 1, i64 0, i64 0, i64 0, i64 0), !dcvm.distance !1
  br label %bb3

bb3:                                              ; preds = %bb0, %bb1
  %r1.0 = phi i64 [ %__CallFf_48___call, %bb1 ], [ %arg_1, %bb0 ]
  %__CallFf_58___call = tail call i64 @set-high-contrast-mode-type(i64 %r1.0, i64 6), !dcvm.distance !1
  %__CallFf_62___call = tail call i64 @"is-player?"(i64 %arg_0), !dcvm.distance !1
  %__BranchIfNot_63___bool.not = icmp eq i64 %__CallFf_62___call, 0
  br i1 %__BranchIfNot_63___bool.not, label %bb5, label %bb4

bb4:                                              ; preds = %bb3
  %__CallFf_69___call = tail call i64 @set-instance-flag-hero(i64 %r1.0, i64 1), !dcvm.distance !1
  %__CallFf_75___call = tail call i64 @set-show-in-flashlight-flag(i64 %r1.0, i64 0), !dcvm.distance !1
  br label %bb6

bb5:                                              ; preds = %bb3
  %__CallFf_82___call = tail call i64 @set-shadow-casting-from-npc-flashlight(i64 %r1.0, i64 0), !dcvm.distance !1
  br label %bb6

bb6:                                              ; preds = %bb5, %bb4
  %__CallFf_88___call = tail call i64 @set-gas-mask(i64 %arg_0, i64 %r1.0), !dcvm.distance !1
  %__CallFf_94___call = tail call i64 @set-visible(i64 %r1.0, i64 0), !dcvm.distance !1
  %__CallFf_98___call = tail call i64 @"is-player?"(i64 %arg_0), !dcvm.distance !1
  %__OpLogNot_99__op = icmp eq i64 %__CallFf_98___call, 0
  br i1 %__OpLogNot_99__op, label %bb7, label %bb9

bb7:                                              ; preds = %bb6
  %__CallFf_102___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  br label %bb9

bb9:                                              ; preds = %bb6, %bb7
  %__CallFf_114___call = tail call i64 @attach(i64 %r1.0, i64 %arg_0, i64 8667864169316382944, float 0.000000e+00), !dcvm.distance !1
  %__CallFf_123___call = tail call i64 @new-boxed-value(i64 6, float 0x3FD3333340000000), !dcvm.distance !1
  %__CallFf_127___call = tail call i64 @send-event(i64 6817768622307059015, i64 %arg_0, i64 %__CallFf_123___call), !dcvm.distance !1
  %__IAddImm_132__op = getelementptr i8, ptr %0, i64 16
  %__LoadU64_133___load = load i64, ptr %__IAddImm_132__op, align 4
  %__CallFf_143___call = tail call i64 @"#%alloc-array"(i64 8534565298598421705, i64 16, i64 0, i64 1), !dcvm.distance !1
  %__CallFf_149___call = tail call i64 @animate_(i64 %r1.0, i64 %__LoadU64_133___load, i64 %__CallFf_143___call), !dcvm.distance !1
  br label %bb10

bb10:                                             ; preds = %bb11, %bb9
  %__LoadU64_154___load = load i64, ptr %0, align 4
  %__CallFf_156___call = tail call i64 @alloc-gesture-play-params(), !dcvm.distance !1
  ...
  %__CallFf_178___call = tail call i64 @gesture_(i64 %arg_0, i64 %__LoadU64_154___load, i64 %__CallFf_156___call), !dcvm.distance !1
  %__IEqual_180__op.not = icmp eq i64 %__CallFf_178___call, 0
  br i1 %__IEqual_180__op.not, label %bb12, label %bb11

bb11:                                             ; preds = %bb10
  %__CallFf_184___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  br label %bb10

bb12:                                             ; preds = %bb10
  %__IAddImm_190__op = getelementptr i8, ptr %0, i64 24
  %__LoadU64_191___load = load i64, ptr %__IAddImm_190__op, align 4
  %__CallFf_201___call = tail call i64 @"#%alloc-array"(i64 8534565298598421705, i64 16, i64 0, i64 1), !dcvm.distance !1
  %__CallFf_207___call = tail call i64 @animate_(i64 %r1.0, i64 %__LoadU64_191___load, i64 %__CallFf_201___call), !dcvm.distance !1
  ret i64 %__CallFf_207___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !11 i64 @lookup-symbol(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !12 i64 @get-gas-mask-setting-id(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !13 i64 @wait-until-in-valid-gas-mask-state(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !14 i64 @spawn-object(i64, i64, i64, i64, i64, i64, i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !15 i64 @set-high-contrast-mode-type(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !16 i64 @"is-player?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !17 i64 @set-instance-flag-hero(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !18 i64 @set-show-in-flashlight-flag(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !19 i64 @set-shadow-casting-from-npc-flashlight(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !20 i64 @set-gas-mask(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !21 i64 @set-visible(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !22 i64 @attach(i64, i64, i64, float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !23 i64 @animate_(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !24 i64 @"#%alloc-array"(i64, i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !25 i64 @gesture_(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !26 i64 @alloc-gesture-play-params() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @internal-put-on-gas-mask-immediately.2(i64 %arg_0, i64 %arg_1) local_unnamed_addr #1 !dcvm.sid_distance !27 {
bb0:
  %__CallFf_6___call = tail call i64 @get-gas-mask-setting-id(i64 %arg_0), !dcvm.distance !1
  %__CallFf_10___call = tail call i64 @lookup-symbol(i64 %__CallFf_6___call, i64 3455792245619945009), !dcvm.distance !1
...
bb1:                                              ; preds = %bb0
  ...
  %__CallFf_37___call = tail call i64 @spawn-object(i64 %__LoadU64_19___load, i64 267125575217391726, i64 0, i64 0, i64 1, i64 0, i64 0, i64 0, i64 0), !dcvm.distance !1
  br label %bb3

bb3:                                              ; preds = %bb0, %bb1
  %r1.0 = phi i64 [ %__CallFf_37___call, %bb1 ], [ %arg_1, %bb0 ]
  %__CallFf_47___call = tail call i64 @set-high-contrast-mode-type(i64 %r1.0, i64 6), !dcvm.distance !1
  %__CallFf_53___call = tail call i64 @set-gas-mask(i64 %arg_0, i64 %r1.0), !dcvm.distance !1
  %__CallFf_57___call = tail call i64 @"is-player?"(i64 %arg_0), !dcvm.distance !1
  %__BranchIfNot_58___bool.not = icmp eq i64 %__CallFf_57___call, 0
  br i1 %__BranchIfNot_58___bool.not, label %bb6, label %bb4

bb4:                                              ; preds = %bb3
  %__CallFf_67___call = tail call i64 @new-boxed-value(i64 6, float 0.000000e+00), !dcvm.distance !1
  %__CallFf_71___call = tail call i64 (i64, i64, ...) @send-event(i64 6817768622307059015, i64 %arg_0, i64 %__CallFf_67___call), !dcvm.distance !1
  %__CallFf_77___call = tail call i64 @set-instance-flag-hero(i64 %r1.0, i64 1), !dcvm.distance !1
  br label %bb6

bb6:                                              ; preds = %bb3, %bb4
  %__CallFf_85___call = tail call i64 (i64, i64, ...) @send-event(i64 1827492438953869695, i64 %arg_0), !dcvm.distance !1
  %__CallFf_89___call = tail call i64 @"is-player?"(i64 %arg_0), !dcvm.distance !1
  %__BranchIfNot_90___bool.not = icmp eq i64 %__CallFf_89___call, 0
  br i1 %__BranchIfNot_90___bool.not, label %bb8, label %bb7

bb7:                                              ; preds = %bb6
  %__CallFf_96___call = tail call i64 @set-show-in-flashlight-flag(i64 %r1.0, i64 0), !dcvm.distance !1
  br label %bb9

bb8:                                              ; preds = %bb6
  %__CallFf_103___call = tail call i64 @set-shadow-casting-from-npc-flashlight(i64 %r1.0, i64 0), !dcvm.distance !1
  br label %bb9
...
bb9:                                              ; preds = %bb8, %bb7
  ...
  %__CallFf_119___call = tail call i64 @"#%alloc-array"(i64 8534565298598421705, i64 16, i64 1, i64 1), !dcvm.distance !1
  ...
  %__CallFf_151___call = tail call i64 @animate_(i64 %r1.0, i64 %__LoadU64_109___load, i64 %__CallFf_119___call), !dcvm.distance !1
  ret i64 %__CallFf_151___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @get-equipped-gas-mask(i64 %arg_0) local_unnamed_addr #1 !dcvm.sid_distance !28 {
bb0:
  %__CallFf_4___call = tail call i64 @get-gas-mask(i64 %arg_0), !dcvm.distance !1
  ret i64 %__CallFf_4___call
}

; Function Attrs: nosync nounwind
define i64 @wait-until-in-valid-gas-mask-state.3(i64 %arg_0, i64 %arg_1) local_unnamed_addr #0 !dcvm.sid_distance !29 {
bb0:
  %__CallFf_5___call = tail call i64 @"is-player?"(i64 %arg_0), !dcvm.distance !1
  %__BranchIfNot_6___bool.not = icmp eq i64 %__CallFf_5___call, 0
  br i1 %__BranchIfNot_6___bool.not, label %bb15, label %bb1

bb1:                                              ; preds = %bb0, %bb3
  %__CallFf_10___call = tail call i64 @"player-in-state?"(i64 6740565536053766520), !dcvm.distance !1
  %__OpLogNot_11__op = icmp eq i64 %__CallFf_10___call, 0
  br i1 %__OpLogNot_11__op, label %bb2, label %bb3

bb2:                                              ; preds = %bb1
  %__CallFf_16___call = tail call i64 @"player-in-state?"(i64 2237451099064635199), !dcvm.distance !1
  %__OpLogNot_17__op.not = icmp eq i64 %__CallFf_16___call, 0
  br i1 %__OpLogNot_17__op.not, label %bb4, label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %__CallFf_21___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  br label %bb1
...
bb5:                                              ; preds = %bb4
  %__CallFf_26___call = tail call i64 @player-force-crouch(), !dcvm.distance !1
  %__CallFf_28___call66 = tail call i64 @"player-is-crouched?"(), !dcvm.distance !1
...
bb12.preheader:                                   ; preds = %bb7, %bb11, %bb5, %bb9
  %__CallFf_50___call71 = tail call i64 @"player-in-state?"(i64 4007104907368024212), !dcvm.distance !1
  %__OpLogNot_51__op72 = icmp eq i64 %__CallFf_50___call71, 0
  br i1 %__OpLogNot_51__op72, label %bb13, label %bb14

bb7:                                              ; preds = %bb5, %bb7
  %__CallFf_32___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  %__CallFf_28___call = tail call i64 @"player-is-crouched?"(), !dcvm.distance !1
  %__OpLogNot_29__op = icmp eq i64 %__CallFf_28___call, 0
  br i1 %__OpLogNot_29__op, label %bb7, label %bb12.preheader

bb9:                                              ; preds = %bb4
  %__CallFf_36___call = tail call i64 @player-force-stand(), !dcvm.distance !1
  %__CallFf_39___call68 = tail call i64 @"player-is-crouched?"(), !dcvm.distance !1
  %__Call_41___call69 = tail call i64 @"!"(i64 %__CallFf_39___call68)
  %__OpLogNot_42__op70 = icmp eq i64 %__Call_41___call69, 0
  br i1 %__OpLogNot_42__op70, label %bb11, label %bb12.preheader

bb11:                                             ; preds = %bb9, %bb11
  %__CallFf_45___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  %__CallFf_39___call = tail call i64 @"player-is-crouched?"(), !dcvm.distance !1
...
bb13:                                             ; preds = %bb12.preheader, %bb13
  %__CallFf_54___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  %__CallFf_50___call = tail call i64 @"player-in-state?"(i64 4007104907368024212), !dcvm.distance !1
...
bb14:                                             ; preds = %bb13, %bb12.preheader
  %__CallFf_61___call = tail call i64 @wait-holster-player-weapon(i64 0, float 1.000000e+00), !dcvm.distance !1
  %__CallFf_67___call = tail call i64 @holster-player-weapon-instantly(float 0x3FC99999A0000000, i64 0), !dcvm.distance !1
  br label %bb21

bb15:                                             ; preds = %bb0
  %__CallFf_80___call = tail call i64 @wait-npc-holster-weapon(i64 %arg_0, i64 0, i64 1, float -1.000000e+00, i64 0), !dcvm.distance !1
  %__CallFf_84___call73 = tail call i64 @"npc-has-weapon-in-hand?"(i64 %arg_0), !dcvm.distance !1
...
bb17:                                             ; preds = %bb15, %bb17
  %__CallFf_87___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  %__CallFf_84___call = tail call i64 @"npc-has-weapon-in-hand?"(i64 %arg_0), !dcvm.distance !1
...
bb19:                                             ; preds = %bb18
  %__CallFf_96___call = tail call i64 @wait-npc-set-demeanor(i64 %arg_0, i64 3), !dcvm.distance !1
  br label %bb21
...
; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !30 i64 @"player-in-state?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !31 i64 @player-force-crouch() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !32 i64 @"player-is-crouched?"() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !33 i64 @player-force-stand() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !34 i64 @"!"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !35 i64 @wait-holster-player-weapon(i64, float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !36 i64 @holster-player-weapon-instantly(float, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !37 i64 @wait-npc-holster-weapon(i64, i64, i64, float, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !38 i64 @"npc-has-weapon-in-hand?"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !39 i64 @wait-npc-set-demeanor(i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @"npc-gas-mask-narrative-mode/f"(i64 %arg_0) local_unnamed_addr #1 !dcvm.sid_distance !40 {
bb0:
  %__CallFf_6___call = tail call i64 @send-event(i64 8119835013146602502, i64 %arg_0), !dcvm.distance !1
  %__Call_10___call = tail call i64 @"suspend-idle-gestures/f"(i64 %arg_0)
  %__CallFf_16___call = tail call i64 @npc-disable-dialog-look(i64 %arg_0, float 0.000000e+00), !dcvm.distance !1
  ret i64 %__CallFf_16___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !41 i64 @"suspend-idle-gestures/f"(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !42 i64 @npc-disable-dialog-look(i64, float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @internal-put-off-gas-mask-immediately(i64 %arg_0, i64 %arg_1) local_unnamed_addr #1 !dcvm.sid_distance !43 {
bb0:
  %__CallFf_5___call = tail call i64 @get-gas-mask(i64 %arg_0), !dcvm.distance !1
  %__CallFf_11___call = tail call i64 @send-event(i64 -3264453205741318791, i64 %arg_0), !dcvm.distance !1
  %__BranchIfNot_13___bool.not = icmp eq i64 %arg_1, 0
  br i1 %__BranchIfNot_13___bool.not, label %bb3, label %bb1

bb1:                                              ; preds = %bb0
  %__CallFf_17___call = tail call i64 @kill-entity(i64 %__CallFf_5___call), !dcvm.distance !1
  br label %bb3
...
; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !44 i64 @kill-entity(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @spawn-gas-mask(i64 %arg_0) local_unnamed_addr #1 !dcvm.sid_distance !45 {
bb0:
  %__CallFf_5___call = tail call i64 @get-gas-mask-setting-id(i64 %arg_0), !dcvm.distance !1
  %__CallFf_9___call = tail call i64 @lookup-symbol(i64 %__CallFf_5___call, i64 3455792245619945009), !dcvm.distance !1
  ...
  %__CallFf_32___call = tail call i64 @spawn-object(i64 %__LoadU64_14___load, i64 267125575217391726, i64 0, i64 0, i64 1, i64 0, i64 0, i64 0, i64 0), !dcvm.distance !1
  %__CallFf_38___call = tail call i64 @set-high-contrast-mode-type(i64 %__CallFf_32___call, i64 6), !dcvm.distance !1
  ret i64 %__CallFf_32___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @"player-gas-mask-narrative-mode/f"(i64 %arg_0, i64 %arg_1, i64 %arg_2) local_unnamed_addr #1 !dcvm.sid_distance !46 {
bb0:
  %__CallFf_6___call = tail call i64 @player-disable-dialog-look-gestures(float 0.000000e+00), !dcvm.distance !1
  %__CallFf_8___call = tail call i64 @"player-disable-squeeze-through/f"(), !dcvm.distance !1
  ...
  %__CallFf_24___call = tail call i64 @joypad-disable-commands(i64 -1699981380503476753), !dcvm.distance !1
  ret i64 %__CallFf_24___call
}

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !47 i64 @player-disable-dialog-look-gestures(float) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !48 i64 @"player-disable-squeeze-through/f"() local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !49 i64 @"player-set-narrative-mode/f"(i64, i64, i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
declare !dcvm.sid_distance !50 i64 @joypad-disable-commands(i64) local_unnamed_addr #1

; Function Attrs: mustprogress nosync nounwind willreturn
define i64 @internal-put-off-gas-mask(i64 %arg_0, i64 %arg_1) local_unnamed_addr #1 !dcvm.sid_distance !51 {
bb0:
  %__CallFf_3___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  %__CallFf_8___call = tail call i64 @get-gas-mask-setting-id(i64 %arg_0), !dcvm.distance !1
  %__CallFf_12___call = tail call i64 @lookup-symbol(i64 %__CallFf_8___call, i64 3455792245619945009), !dcvm.distance !1
  %__CallFf_16___call = tail call i64 @get-gas-mask(i64 %arg_0), !dcvm.distance !1
  %0 = inttoptr i64 %__CallFf_12___call to ptr
  ...
  %__CallFf_41___call = tail call i64 @"#%alloc-array"(i64 8534565298598421705, i64 16, i64 0, i64 1), !dcvm.distance !1
  %__CallFf_47___call = tail call i64 @animate_(i64 %__CallFf_16___call, i64 %__LoadU64_31___load, i64 %__CallFf_41___call), !dcvm.distance !1
  %__IAddImm_52__op = getelementptr i8, ptr %0, i64 8
  br label %bb1

bb1:                                              ; preds = %bb2, %bb0
  %__LoadU64_53___load = load i64, ptr %__IAddImm_52__op, align 4
  %__CallFf_55___call = tail call i64 @alloc-gesture-play-params(), !dcvm.distance !1
  ...
  store i8 1, ptr %4, align 1
  %__CallFf_77___call = tail call i64 @gesture_(i64 %arg_0, i64 %__LoadU64_53___load, i64 %__CallFf_55___call), !dcvm.distance !1
  %__IEqual_79__op.not = icmp eq i64 %__CallFf_77___call, 0
  br i1 %__IEqual_79__op.not, label %bb3, label %bb2

bb2:                                              ; preds = %bb1
  %__CallFf_83___call = tail call i64 @wait-one-frame(), !dcvm.distance !1
  br label %bb1
...
bb4:                                              ; preds = %bb3
  %__CallFf_90___call = tail call i64 @kill-entity(i64 %__CallFf_16___call), !dcvm.distance !1
  br label %bb6
...
; Function Attrs: nosync nounwind
define i64 @wait-remove-gas-mask(i64 %arg_0, i64 %arg_1, i64 %arg_2) local_unnamed_addr #0 !dcvm.sid_distance !52 {
bb0:
  %__CallFf_11___call = tail call i64 @new-boxed-value(i64 1, i64 0), !dcvm.distance !1
  %__CallFf_15___call = tail call i64 @fact-set(i64 %arg_0, i64 7671589888336862994, i64 %__CallFf_11___call), !dcvm.distance !1
...
bb3:                                              ; preds = %bb2, %bb0
  %__CallFf_33___call = tail call i64 @new-boxed-value(i64 7, i64 %arg_0), !dcvm.distance !1
  %__CallFf_37___call = tail call i64 @send-event(i64 -3325057813225958160, i64 6150028017864311825, i64 %__CallFf_33___call), !dcvm.distance !1
  %__BranchIfNot_39___bool.not = icmp eq i64 %arg_1, 0
  br i1 %__BranchIfNot_39___bool.not, label %bb5, label %bb4

bb4:                                              ; preds = %bb3
  %__CallFf_5___call.i = tail call i64 @get-gas-mask(i64 %arg_0), !dcvm.distance !1
  %__CallFf_11___call.i = tail call i64 @send-event(i64 -3264453205741318791, i64 %arg_0), !dcvm.distance !1
  %__BranchIfNot_13___bool.not.i = icmp eq i64 %arg_2, 0
  br i1 %__BranchIfNot_13___bool.not.i, label %bb6, label %bb1.i

bb1.i:                                            ; preds = %bb4
  %__CallFf_17___call.i = tail call i64 @kill-entity(i64 %__CallFf_5___call.i), !dcvm.distance !1
  br label %bb6
