...
bb0:
  ...
  %__Call_19___call51 = tail call i64 %"__LookupPointer_is-script-running?_fptr"(i64 6150028017864311825) #3, !callees !2
...
bb3:                                              ; preds = %bb2, %bb0
  ...
  %__Call_56___call52 = tail call i64 %"__LookupPointer_is-script-running?_fptr"(i64 6150028017864311825) #3, !callees !2
  %2 = trunc i64 %__Call_56___call52 to i1
  br i1 %2, label %bb8, label %bb7.preheader

bb7.preheader:                                    ; preds = %bb3
  %__LookupPointer_wait-one-frame_fptr56 = tail call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  br label %bb7

bb7:                                              ; preds = %bb7.preheader, %bb7
  %__CallFf_60___call = tail call i64 %__LookupPointer_wait-one-frame_fptr56() #3, !callees !3
...
bb0:
  ...
  %__Call_21___call = tail call i64 %__LookupPointer_wait-until-in-valid-gas-mask-state_fptr(i64 %arg_0, i64 %__LoadU8_18___ext) #3, !callees !10
...
bb1:                                              ; preds = %bb0
  ...
  %__CallFf_48___call = tail call i64 %__LookupPointer_spawn-object_fptr(i64 %__LoadU64_30___load, i64 267125575217391726, i64 0, i64 0, i64 1, i64 0, i64 0, i64 0, i64 0) #3, !callees !11
  br label %bb3
...
bb3:                                              ; preds = %bb0, %bb1
  ...
  %__CallFf_58___call = tail call i64 %__LookupPointer_set-high-contrast-mode-type_fptr(i64 %r1.0, i64 6) #3, !callees !12
  %"__LookupPointer_is-player?_fptr" = tail call ptr @llvm.dcvm.lookup(i64 6532480022340268902)
  %__CallFf_62___call = tail call i64 %"__LookupPointer_is-player?_fptr"(i64 %arg_0) #3, !callees !13
...
bb4:                                              ; preds = %bb3
  ...
  %__CallFf_69___call = tail call i64 %__LookupPointer_set-instance-flag-hero_fptr(i64 %r1.0, i64 1) #3, !callees !14
...
bb6:                                              ; preds = %bb5, %bb4
  ...
  %__CallFf_88___call = tail call i64 %__LookupPointer_set-gas-mask_fptr(i64 %arg_0, i64 %r1.0) #3, !callees !15
  %__LookupPointer_set-visible_fptr = tail call ptr @llvm.dcvm.lookup(i64 -7746349783173232884)
  %__CallFf_94___call = tail call i64 %__LookupPointer_set-visible_fptr(i64 %r1.0, i64 0) #3, !callees !16
  %__CallFf_98___call = tail call i64 %"__LookupPointer_is-player?_fptr"(i64 %arg_0) #3, !callees !13
  %1 = trunc i64 %__CallFf_98___call to i1
  br i1 %1, label %bb9, label %bb7

bb7:                                              ; preds = %bb6
  %__CallFf_102___call = tail call i64 %__LookupPointer_wait-one-frame_fptr() #3, !callees !3
  br label %bb9

bb9:                                              ; preds = %bb6, %bb7
  %__LookupPointer_attach_fptr = tail call ptr @llvm.dcvm.lookup(i64 -5676660224586178492)
  %__CallFf_114___call = tail call i64 %__LookupPointer_attach_fptr(i64 %r1.0, i64 %arg_0, i64 8667864169316382944, float 0.000000e+00) #3, !callees !17
  %__CallFf_123___call = tail call i64 @new-boxed-value(i64 6, float 0x3FD3333340000000)
  %__LookupPointer_send-event_fptr = tail call ptr @llvm.dcvm.lookup(i64 4789555171397753330)
  %__CallFf_127___call = tail call i64 %__LookupPointer_send-event_fptr(i64 6817768622307059015, i64 %arg_0, i64 %__CallFf_123___call) #3, !callees !4
  ...
  %__CallFf_143___call = tail call i64 %"__LookupPointer_#%alloc-array_fptr"(i64 8534565298598421705, i64 16, i64 0, i64 1) #3, !callees !18
  %__LookupPointer_animate__fptr = tail call ptr @llvm.dcvm.lookup(i64 -9179819928081802467)
  %__CallFf_149___call = tail call i64 %__LookupPointer_animate__fptr(i64 %r1.0, i64 %__LoadU64_133___load, i64 %__CallFf_143___call) #3, !callees !19
...
bb10:                                             ; preds = %bb11, %bb9
  ...
  %__CallFf_156___call = tail call i64 %__LookupPointer_alloc-gesture-play-params_fptr() #3, !callees !20
  ...
  %__CallFf_178___call = tail call i64 %__LookupPointer_gesture__fptr(i64 %arg_0, i64 %__LoadU64_154___load, i64 %__CallFf_156___call) #3, !callees !21
  %__IEqual_180__op.not = icmp eq i64 %__CallFf_178___call, 0
  br i1 %__IEqual_180__op.not, label %bb12, label %bb11

bb11:                                             ; preds = %bb10
  %__CallFf_184___call = tail call i64 %__LookupPointer_wait-one-frame_fptr() #3, !callees !3
  br label %bb10

bb12:                                             ; preds = %bb10
  %__IAddImm_190__op = getelementptr i8, ptr %0, i64 24
  %__LoadU64_191___load = load i64, ptr %__IAddImm_190__op, align 4
  %__CallFf_201___call = tail call i64 %"__LookupPointer_#%alloc-array_fptr"(i64 8534565298598421705, i64 16, i64 0, i64 1) #3, !callees !18
  %__CallFf_207___call = tail call i64 %__LookupPointer_animate__fptr(i64 %r1.0, i64 %__LoadU64_191___load, i64 %__CallFf_201___call) #3, !callees !19
...
bb0:
  %__LookupPointer_get-gas-mask-setting-id_fptr = tail call ptr @llvm.dcvm.lookup(i64 -6573555005595409285)
  %__CallFf_6___call = tail call i64 %__LookupPointer_get-gas-mask-setting-id_fptr(i64 %arg_0) #3, !callees !8
  %__LookupPointer_lookup-symbol_fptr = tail call ptr @llvm.dcvm.lookup(i64 -7658033447216601854)
  %__CallFf_10___call = tail call i64 %__LookupPointer_lookup-symbol_fptr(i64 %__CallFf_6___call, i64 3455792245619945009) #3, !callees !9
...
bb1:                                              ; preds = %bb0
  ...
  %__LookupPointer_spawn-object_fptr = tail call ptr @llvm.dcvm.lookup(i64 7097052834867614476)
  %__CallFf_37___call = tail call i64 %__LookupPointer_spawn-object_fptr(i64 %__LoadU64_19___load, i64 267125575217391726, i64 0, i64 0, i64 1, i64 0, i64 0, i64 0, i64 0) #3, !callees !11
  br label %bb3

bb3:                                              ; preds = %bb0, %bb1
  %r1.0 = phi i64 [ %__CallFf_37___call, %bb1 ], [ %arg_1, %bb0 ]
  %__LookupPointer_set-high-contrast-mode-type_fptr = tail call ptr @llvm.dcvm.lookup(i64 4766017279285775524)
  %__CallFf_47___call = tail call i64 %__LookupPointer_set-high-contrast-mode-type_fptr(i64 %r1.0, i64 6) #3, !callees !12
  %__LookupPointer_set-gas-mask_fptr = tail call ptr @llvm.dcvm.lookup(i64 -5971891483814290574)
  %__CallFf_53___call = tail call i64 %__LookupPointer_set-gas-mask_fptr(i64 %arg_0, i64 %r1.0) #3, !callees !15
  %"__LookupPointer_is-player?_fptr" = tail call ptr @llvm.dcvm.lookup(i64 6532480022340268902)
  %__CallFf_57___call = tail call i64 %"__LookupPointer_is-player?_fptr"(i64 %arg_0) #3, !callees !13
...
bb4:                                              ; preds = %bb3
  ...
  %__LookupPointer_set-instance-flag-hero_fptr = tail call ptr @llvm.dcvm.lookup(i64 -429226074377614887)
  %__CallFf_77___call = tail call i64 %__LookupPointer_set-instance-flag-hero_fptr(i64 %r1.0, i64 1) #3, !callees !14
  br label %bb6

bb6:                                              ; preds = %bb3, %bb4
  %__CallFf_85___call = tail call i64 (i64, i64, ...) @send-event(i64 1827492438953869695, i64 %arg_0)
  %__CallFf_89___call = tail call i64 %"__LookupPointer_is-player?_fptr"(i64 %arg_0) #3, !callees !13
  ...
  %"__LookupPointer_#%alloc-array_fptr" = tail call ptr @llvm.dcvm.lookup(i64 -7745656483000545638)
  %__CallFf_119___call = tail call i64 %"__LookupPointer_#%alloc-array_fptr"(i64 8534565298598421705, i64 16, i64 1, i64 1) #3, !callees !18
  ...
  %__LookupPointer_animate__fptr = tail call ptr @llvm.dcvm.lookup(i64 -9179819928081802467)
  %__CallFf_151___call = tail call i64 %__LookupPointer_animate__fptr(i64 %r1.0, i64 %__LoadU64_109___load, i64 %__CallFf_119___call) #3, !callees !19
...
bb4:                                              ; preds = %bb2
  ...
  %"__LookupPointer_player-is-crouched?_fptr80" = tail call ptr @llvm.dcvm.lookup(i64 1646463116072042322)
...
bb5:                                              ; preds = %bb4
  ...
  %__CallFf_28___call66 = tail call i64 %"__LookupPointer_player-is-crouched?_fptr80"() #3, !callees !24
  %2 = trunc i64 %__CallFf_28___call66 to i1
  br i1 %2, label %bb12.preheader, label %bb7

bb12.preheader:                                   ; preds = %bb7, %bb11, %bb5, %bb9
  %__CallFf_50___call69 = tail call i64 %"__LookupPointer_player-in-state?_fptr"(i64 4007104907368024212) #3, !callees !22
...
bb7:                                              ; preds = %bb5, %bb7
  ...
  %__CallFf_28___call = tail call i64 %"__LookupPointer_player-is-crouched?_fptr80"() #3, !callees !24
...
bb9:                                              ; preds = %bb4
  ...
  %__CallFf_39___call67 = tail call i64 %"__LookupPointer_player-is-crouched?_fptr80"() #3, !callees !24
  %"__LookupPointer_!_fptr" = tail call ptr @llvm.dcvm.lookup(i64 -5808627241898115124)
  %__Call_41___call68 = tail call i64 %"__LookupPointer_!_fptr"(i64 %__CallFf_39___call67) #3, !callees !26
...
bb11:                                             ; preds = %bb9, %bb11
  ...
  %__CallFf_39___call = tail call i64 %"__LookupPointer_player-is-crouched?_fptr80"() #3, !callees !24
...
bb15:                                             ; preds = %bb0
  ...
  %__CallFf_84___call70 = tail call i64 %"__LookupPointer_npc-has-weapon-in-hand?_fptr"(i64 %arg_0) #3, !callees !30
  %__BranchIfNot_85___bool.not71 = icmp eq i64 %__CallFf_84___call70, 0
  br i1 %__BranchIfNot_85___bool.not71, label %bb18, label %bb17.preheader

bb17.preheader:                                   ; preds = %bb15
  %__LookupPointer_wait-one-frame_fptr86 = tail call ptr @llvm.dcvm.lookup(i64 -3047912596559836939)
  br label %bb17

bb17:                                             ; preds = %bb17.preheader, %bb17
  %__CallFf_87___call = tail call i64 %__LookupPointer_wait-one-frame_fptr86() #3, !callees !3
...
bb0:
  ...
  %__LookupPointer_animate__fptr = tail call ptr @llvm.dcvm.lookup(i64 -9179819928081802467)
  %__CallFf_47___call = tail call i64 %__LookupPointer_animate__fptr(i64 %__CallFf_16___call, i64 %__LoadU64_31___load, i64 %__CallFf_41___call) #3, !callees !19
...
bb1:                                              ; preds = %bb2, %bb0
  ...
  %__CallFf_55___call = tail call i64 %__LookupPointer_alloc-gesture-play-params_fptr() #3, !callees !20
  ...
  store i8 1, ptr %4, align 1
  %__CallFf_77___call = tail call i64 %__LookupPointer_gesture__fptr(i64 %arg_0, i64 %__LoadU64_53___load, i64 %__CallFf_55___call) #3, !callees !21
...
bb0:
  ...
  %__CallFf_15___call = tail call i64 %__LookupPointer_fact-set_fptr(i64 %arg_0, i64 7671589888336862994, i64 %__CallFf_11___call) #3, !callees !1
  %"__LookupPointer_is-script-running?_fptr" = tail call ptr @llvm.dcvm.lookup(i64 6481843155139167450)
  %__Call_19___call41 = tail call i64 %"__LookupPointer_is-script-running?_fptr"(i64 6150028017864311825) #3, !callees !2
...
bb5:                                              ; preds = %bb3
  ...
  %__Call_52___call = tail call i64 %__LookupPointer_internal-put-off-gas-mask_fptr(i64 %arg_0, i64 %arg_2) #3, !callees !41
  br label %bb6
...
!41 = !{ptr @internal-put-off-gas-mask}
