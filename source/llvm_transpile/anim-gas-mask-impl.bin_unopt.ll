...
define i64 @internal-put-on-gas-mask(i64 %arg_0, i64 %arg_1) #0 !dcvm.sid_distance !2 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
; Function Attrs: nosync nounwind willreturn
define i64 @internal-put-on-gas-mask-immediately(i64 %arg_0, i64 %arg_1) #0 !dcvm.sid_distance !3 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
bb9:                                              ; preds = %bb8, %bb7
  ...
  %33 = inttoptr i64 %__IAdd_124___load_lhs to ptr
  %__IAdd_124___load_rhs = load i64, ptr %r8, align 4
  %__IAdd_124__op = getelementptr i8, ptr %33, i64 %__IAdd_124___load_rhs
  %34 = ptrtoint ptr %__IAdd_124__op to i64
  ...
  %40 = inttoptr i64 %__IAdd_132___load_lhs to ptr
  %__IAdd_132___load_rhs = load i64, ptr %r8, align 4
  %__IAdd_132__op = getelementptr i8, ptr %40, i64 %__IAdd_132___load_rhs
  %41 = ptrtoint ptr %__IAdd_132__op to i64
  store i64 %41, ptr %r7, align 4
  ...
  %44 = inttoptr i64 %__IAddImm_134___load_lhs to ptr
  %__IAddImm_134__op = getelementptr i8, ptr %44, i8 8
  %45 = ptrtoint ptr %__IAddImm_134__op to i64
  ...
  %46 = inttoptr i64 %__StorePointer_136___addr to ptr
  store i64 %__StorePointer_136___value, ptr %46, align 4
  ...
  %49 = inttoptr i64 %__IAdd_141___load_lhs to ptr
  %__IAdd_141___load_rhs = load i64, ptr %r8, align 4
  %__IAdd_141__op = getelementptr i8, ptr %49, i64 %__IAdd_141___load_rhs
  %50 = ptrtoint ptr %__IAdd_141__op to i64
  store i64 %50, ptr %r7, align 4
  %__LoadPointer_142___addr = load i64, ptr %r7, align 4
  %51 = inttoptr i64 %__LoadPointer_142___addr to ptr
  %__LoadPointer_142___load = load ptr, ptr %51, align 8
  %52 = ptrtoint ptr %__LoadPointer_142___load to i64
  store i64 %52, ptr %r7, align 4
  %__IAddImm_143___load_lhs = load i64, ptr %r7, align 4
  %53 = inttoptr i64 %__IAddImm_143___load_lhs to ptr
  %__IAddImm_143__op = getelementptr i8, ptr %53, i8 8
  %54 = ptrtoint ptr %__IAddImm_143__op to i64
  store i64 %54, ptr %r7, align 4
  store i64 1, ptr %r8, align 4
  %__StoreU8_145___value = load i64, ptr %r8, align 4
  %__StoreU8_145___addr = load i64, ptr %r7, align 4
  %55 = inttoptr i64 %__StoreU8_145___addr to ptr
  %__StoreU8_145___trunc = trunc i64 %__StoreU8_145___value to i8
  store i8 %__StoreU8_145___trunc, ptr %55, align 1
  ...
  %56 = inttoptr i64 %__CallFf_151___callee to ptr
  ...
  %__CallFf_151___call = call i64 %56(i64 %__CallFf_151___arg0, i64 %__CallFf_151___arg1, i64 %__CallFf_151___arg2), !dcvm.distance !1
...
define i64 @get-equipped-gas-mask(i64 %arg_0) !dcvm.sid_distance !4 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
; Function Attrs: nosync nounwind willreturn
define i64 @wait-until-in-valid-gas-mask-state(i64 %arg_0, i64 %arg_1) #0 !dcvm.sid_distance !5 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
define i64 @"npc-gas-mask-narrative-mode/f"(i64 %arg_0) !dcvm.sid_distance !6 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
; Function Attrs: nosync nounwind willreturn
define i64 @internal-put-off-gas-mask-immediately(i64 %arg_0, i64 %arg_1) #0 !dcvm.sid_distance !7 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
define i64 @spawn-gas-mask(i64 %arg_0) !dcvm.sid_distance !8 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
define i64 @"player-gas-mask-narrative-mode/f"(i64 %arg_0, i64 %arg_1, i64 %arg_2) !dcvm.sid_distance !9 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
; Function Attrs: nosync nounwind willreturn
define i64 @internal-put-off-gas-mask(i64 %arg_0, i64 %arg_1) #0 !dcvm.sid_distance !10 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
define i64 @wait-remove-gas-mask(i64 %arg_0, i64 %arg_1, i64 %arg_2) !dcvm.sid_distance !11 {
bb0:
  %r0 = alloca i64, align 8
  %r1 = alloca i64, align 8
  %r2 = alloca i64, align 8
...
; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !12 i64 @fact-set(i64, i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !13 i64 @new-boxed-value(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !14 i64 @"is-script-running?"(i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !15 i64 @wait-one-frame() #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !16 i64 @send-event(i64, i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !17 i64 @get-gas-mask(i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !18 i64 @lookup-symbol(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !19 i64 @get-gas-mask-setting-id(i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !20 i64 @spawn-object(i64, i64, i64, i64, i64, i64, i64, i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !21 i64 @set-high-contrast-mode-type(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !22 i64 @"is-player?"(i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !23 i64 @set-instance-flag-hero(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !24 i64 @set-show-in-flashlight-flag(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !25 i64 @set-shadow-casting-from-npc-flashlight(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !26 i64 @set-gas-mask(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !27 i64 @set-visible(i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !28 i64 @attach(i64, i64, i64, float) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !29 i64 @animate_(i64, i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !30 i64 @"#%alloc-array"(i64, i64, i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !31 i64 @gesture_(i64, i64, i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !32 i64 @alloc-gesture-play-params() #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !33 i64 @"player-in-state?"(i64) #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !34 i64 @player-force-crouch() #0

; Function Attrs: nosync nounwind willreturn
declare !dcvm.sid_distance !35 i64 @"player-is-crouched?"() #0
...
!1 = !{!"far"}
!2 = !{!"sid", i64 5608585023750540989, !"distance", !"near"}
!3 = !{!"sid", i64 6078802017353408438, !"distance", !"near"}
!4 = !{!"sid", i64 6464408158396193538}
!5 = !{!"sid", i64 8203816822361639083, !"distance", !"near"}
!6 = !{!"sid", i64 9135517996633164385}
!7 = !{!"sid", i64 -8559530813269772124, !"distance", !"near"}
!8 = !{!"sid", i64 -8188029138696281045}
!9 = !{!"sid", i64 -7406256944386539599}
!10 = !{!"sid", i64 -6610620527767074061, !"distance", !"near"}
!11 = !{!"sid", i64 -1351166648529978758}
!12 = !{!"sid", i64 -2210386714833194546, !"distance", !"far"}
!13 = !{!"sid", i64 3684810824690217768, !"distance", !"far"}
!14 = !{!"sid", i64 6481843155139167450, !"distance", !"near"}
!15 = !{!"sid", i64 -3047912596559836939, !"distance", !"far"}
!16 = !{!"sid", i64 4789555171397753330, !"distance", !"far"}
!17 = !{!"sid", i64 -5076200561558624898, !"distance", !"far"}
!18 = !{!"sid", i64 -7658033447216601854, !"distance", !"far"}
!19 = !{!"sid", i64 -6573555005595409285, !"distance", !"far"}
!20 = !{!"sid", i64 7097052834867614476, !"distance", !"far"}
!21 = !{!"sid", i64 4766017279285775524, !"distance", !"far"}
!22 = !{!"sid", i64 6532480022340268902, !"distance", !"far"}
!23 = !{!"sid", i64 -429226074377614887, !"distance", !"far"}
!24 = !{!"sid", i64 -7252477440030364545, !"distance", !"far"}
!25 = !{!"sid", i64 -3854484060414110792, !"distance", !"far"}
!26 = !{!"sid", i64 -5971891483814290574, !"distance", !"far"}
!27 = !{!"sid", i64 -7746349783173232884, !"distance", !"far"}
!28 = !{!"sid", i64 -5676660224586178492, !"distance", !"far"}
!29 = !{!"sid", i64 -9179819928081802467, !"distance", !"far"}
!30 = !{!"sid", i64 -7745656483000545638, !"distance", !"far"}
!31 = !{!"sid", i64 6500315221283771953, !"distance", !"far"}
!32 = !{!"sid", i64 -2962780980939953026, !"distance", !"far"}
!33 = !{!"sid", i64 -9003251364961024783, !"distance", !"far"}
!34 = !{!"sid", i64 -4831287436211302109, !"distance", !"far"}
