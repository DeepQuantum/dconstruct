...
uint64_t fact_NC_set(uint64_t _1, uint64_t _2, uint64_t _3) __ATTRIBUTELIST__((nothrow));
uint64_t new_NC_boxed_NC_value(uint64_t _4, uint64_t _5) __ATTRIBUTELIST__((nothrow));
uint64_t is_NC_script_NC_running_PD_(uint64_t _6) __ATTRIBUTELIST__((nothrow));
uint64_t wait_NC_one_NC_frame(void) __ATTRIBUTELIST__((nothrow));
uint64_t send_NC_event(uint64_t _7, uint64_t _8, uint64_t _9) __ATTRIBUTELIST__((nothrow));
uint64_t internal_NC_put_NC_on_NC_gas_NC_mask_NC_immediately(uint64_t _10, uint64_t _11) __ATTRIBUTELIST__((nothrow));
uint64_t internal_NC_put_NC_on_NC_gas_NC_mask(uint64_t _12, uint64_t _13) __ATTRIBUTELIST__((nothrow));
uint64_t get_NC_gas_NC_mask(uint64_t _14) __ATTRIBUTELIST__((nothrow));
uint64_t internal_NC_put_NC_on_NC_gas_NC_mask_OC_1(uint64_t llvm_cbe_arg_0, uint64_t llvm_cbe_arg_1);
uint64_t lookup_NC_symbol(uint64_t _15, uint64_t _16) __ATTRIBUTELIST__((nothrow));
uint64_t get_NC_gas_NC_mask_NC_setting_NC_id(uint64_t _17) __ATTRIBUTELIST__((nothrow));
uint64_t wait_NC_until_NC_in_NC_valid_NC_gas_NC_mask_NC_state(uint64_t _18, uint64_t _19) __ATTRIBUTELIST__((nothrow));
uint64_t spawn_NC_object(uint64_t _20, uint64_t _21, uint64_t _22, uint64_t _23, uint64_t _24, uint64_t _25, uint64_t _26, uint64_t _27, uint64_t _28) __ATTRIBUTELIST__((nothrow));
uint64_t set_NC_high_NC_contrast_NC_mode_NC_type(uint64_t _29, uint64_t _30) __ATTRIBUTELIST__((nothrow));
uint64_t is_NC_player_PD_(uint64_t _31) __ATTRIBUTELIST__((nothrow));
uint64_t set_NC_instance_NC_flag_NC_hero(uint64_t _32, uint64_t _33) __ATTRIBUTELIST__((nothrow));
uint64_t set_NC_show_NC_in_NC_flashlight_NC_flag(uint64_t _34, uint64_t _35) __ATTRIBUTELIST__((nothrow));
uint64_t set_NC_shadow_NC_casting_NC_from_NC_npc_NC_flashlight(uint64_t _36, uint64_t _37) __ATTRIBUTELIST__((nothrow));
uint64_t set_NC_gas_NC_mask(uint64_t _38, uint64_t _39) __ATTRIBUTELIST__((nothrow));
uint64_t set_NC_visible(uint64_t _40, uint64_t _41) __ATTRIBUTELIST__((nothrow));
uint64_t attach(uint64_t _42, uint64_t _43, uint64_t _44, float _45) __ATTRIBUTELIST__((nothrow));
uint64_t animate_(uint64_t _46, uint64_t _47, uint64_t _48) __ATTRIBUTELIST__((nothrow));
uint64_t _DC__FC_alloc_NC_array(uint64_t _49, uint64_t _50, uint64_t _51, uint64_t _52) __ATTRIBUTELIST__((nothrow));
uint64_t gesture_(uint64_t _53, uint64_t _54, uint64_t _55) __ATTRIBUTELIST__((nothrow));
...
uint64_t player_NC_in_NC_state_PD_(uint64_t _56) __ATTRIBUTELIST__((nothrow));
...
uint64_t _BC_(uint64_t _57) __ATTRIBUTELIST__((nothrow));
uint64_t wait_NC_holster_NC_player_NC_weapon(uint64_t _58, float _59) __ATTRIBUTELIST__((nothrow));
uint64_t holster_NC_player_NC_weapon_NC_instantly(float _60, uint64_t _61) __ATTRIBUTELIST__((nothrow));
uint64_t wait_NC_npc_NC_holster_NC_weapon(uint64_t _62, uint64_t _63, uint64_t _64, float _65, uint64_t _66) __ATTRIBUTELIST__((nothrow));
uint64_t npc_NC_has_NC_weapon_NC_in_NC_hand_PD_(uint64_t _67) __ATTRIBUTELIST__((nothrow));
uint64_t wait_NC_npc_NC_set_NC_demeanor(uint64_t _68, uint64_t _69) __ATTRIBUTELIST__((nothrow));
uint64_t npc_NC_gas_NC_mask_NC_narrative_NC_mode_PC_f(uint64_t llvm_cbe_arg_0);
uint64_t suspend_NC_idle_NC_gestures_PC_f(uint64_t _70) __ATTRIBUTELIST__((nothrow));
uint64_t npc_NC_disable_NC_dialog_NC_look(uint64_t _71, float _72) __ATTRIBUTELIST__((nothrow));
...
uint64_t kill_NC_entity(uint64_t _73) __ATTRIBUTELIST__((nothrow));
...
uint64_t player_NC_disable_NC_dialog_NC_look_NC_gestures(float _74) __ATTRIBUTELIST__((nothrow));
uint64_t player_NC_disable_NC_squeeze_NC_through_PC_f(void) __ATTRIBUTELIST__((nothrow));
uint64_t player_NC_set_NC_narrative_NC_mode_PC_f(uint64_t _75, uint64_t _76, uint64_t _77) __ATTRIBUTELIST__((nothrow));
uint64_t joypad_NC_disable_NC_commands(uint64_t _78) __ATTRIBUTELIST__((nothrow));
