...
entry:
  %1 = add i64 %0, 1
  %__LookupPointer_helper_kept_fptr = tail call ptr @llvm.dcvm.lookup(i64 2459565876494606882)
  %b = tail call i64 %__LookupPointer_helper_kept_fptr(i64 %1) #3, !callees !1
  %c = tail call i64 %__LookupPointer_helper_kept_fptr(i64 %b) #3, !callees !1
  %2 = add i64 %c, %b
  ret i64 %2
}
