...
namespace dconstruct::dcompiler {
    ...
    [[nodiscard]] const std::pair<ast::full_type, std::optional<std::string>>* decomp_function::find_in_scope() {
        if (m_functionScope) {
    ...
    void decomp_function::parse_basic_block(const control_flow_node& node) {
        ...
        for (const auto& line : node.m_lines) {
            ...
            switch (istr.opcode) {
                case Opcode::IAdd:
                case Opcode::FAdd:
                    generated_expression = apply_binary_op<ast::add_expr>(istr);
                    break;
                case Opcode::ISub:
                case Opcode::FSub:
                    generated_expression = apply_binary_op<ast::sub_expr>(istr);
                    break;
                case Opcode::IMul:
                case Opcode::FMul:
                    generated_expression = apply_binary_op<ast::mul_expr>(istr);
                    break;
                case Opcode::IDiv:
                case Opcode::FDiv:
                    generated_expression = apply_binary_op<ast::div_expr>(istr);
                    break;
                case Opcode::IMod:
                case Opcode::FMod:
                    generated_expression = apply_binary_op<ast::mod_expr>(istr);
                    break;

                case Opcode::IntAsh:
                    generated_expression = make_shift(istr);
                    break;
                case Opcode::QEX_InRangeI:
                    generated_expression = make_in_range(istr);
                    break;

                case Opcode::IAddImm:
                    generated_expression = apply_binary_op_imm<ast::add_expr>(istr);
                    break;
                case Opcode::IMulImm:
                    generated_expression = apply_binary_op_imm<ast::mul_expr>(istr);
                    break;
                case Opcode::ISubImm:
                    generated_expression = apply_binary_op_imm<ast::sub_expr>(istr);
                    break;
                case Opcode::IDivImm:
                    generated_expression = apply_binary_op_imm<ast::div_expr>(istr);
                    break;

                case Opcode::IEqual:
                case Opcode::FEqual:
                    generated_expression = apply_binary_op<ast::compare_expr>(istr, compilation::token{compilation::token_type::EQUAL_EQUAL, "=="});
                    break;
                case Opcode::INotEqual:
                case Opcode::FNotEqual:
                    generated_expression = apply_binary_op<ast::compare_expr>(istr, compilation::token{compilation::token_type::BANG_EQUAL, "!="});
                    break;
                case Opcode::ILessThan:
                case Opcode::FLessThan:
                    generated_expression = apply_binary_op<ast::compare_expr>(istr, compilation::token{compilation::token_type::LESS, "<"});
                    break;
                case Opcode::ILessThanEqual:
                case Opcode::FLessThanEqual:
                    generated_expression = apply_binary_op<ast::compare_expr>(istr, compilation::token{compilation::token_type::LESS_EQUAL, "<="});
                    break;
                case Opcode::IGreaterThan:
                case Opcode::FGreaterThan:
                    generated_expression = apply_binary_op<ast::compare_expr>(istr, compilation::token{compilation::token_type::GREATER, ">"});
                    break;
                case Opcode::IGreaterThanEqual:
                case Opcode::FGreaterThanEqual:
                    generated_expression = apply_binary_op<ast::compare_expr>(istr, compilation::token{compilation::token_type::GREATER_EQUAL, ">="});
                    break;

                case Opcode::OpBitAnd:
                    generated_expression = apply_binary_op<ast::bitwise_and_expr>(istr);
                    break;
                case Opcode::OpBitOr:
                    generated_expression = apply_binary_op<ast::bitwise_or_expr>(istr);
                    break;
                case Opcode::OpBitXor:
                    generated_expression = apply_binary_op<ast::bitwise_xor_expr>(istr);
                    break;
                ...
                case Opcode::OpLogNot:
                    generated_expression = apply_unary_op<ast::logical_not_expr>(istr);
                    break;
                ...
                case Opcode::INeg:
                case Opcode::FNeg:
                    generated_expression = apply_unary_op<ast::negate_expr>(istr);
                    break;

                case Opcode::LoadU16Imm:
                    generated_expression = std::make_unique<ast::literal>(static_cast<u16>(istr.operand1 | static_cast<u16>(istr.operand2) << 8));
                    break;

                case Opcode::LoadStaticInt:
                    generated_expression = std::make_unique<ast::cast_expr>(make_type_from_prim(ast::primitive_kind::U64), make_load_symbol_table(istr));
                    break;
                case Opcode::LoadStaticFloat:
                    generated_expression = std::make_unique<ast::cast_expr>(make_type_from_prim(ast::primitive_kind::F32), make_load_symbol_table(istr));
                    break;
                case Opcode::LoadStaticPointer:
                    generated_expression = std::make_unique<ast::cast_expr>(ast::ptr_type{}, make_load_symbol_table(istr));
                    break;

                case Opcode::LoadStaticI8Imm:
                    generated_expression = std::make_unique<ast::literal>(symbol_table.get<i8>(istr.operand1));
                    break;
                case Opcode::LoadStaticU8Imm:
                    generated_expression = std::make_unique<ast::literal>(symbol_table.get<u8>(istr.operand1));
                    break;
                case Opcode::LoadStaticI16Imm:
                    generated_expression = std::make_unique<ast::literal>(symbol_table.get<i16>(istr.operand1));
                    break;
                case Opcode::LoadStaticU16Imm:
                    generated_expression = std::make_unique<ast::literal>(symbol_table.get<u16>(istr.operand1));
                    break;

                case Opcode::LoadStaticI32Imm:
                    generated_expression = std::make_unique<ast::literal>(symbol_table.get<i32>(istr.operand1));
                    break;

                case Opcode::LoadStaticU32Imm: {
                    if (m_is64Bit) {
                        generated_expression = std::make_unique<ast::literal>(symbol_table.get<u32>(istr.operand1));
                        break;
                    } else {
                ...
                case Opcode::LoadStaticI64Imm:
                    generated_expression = std::make_unique<ast::literal>(symbol_table.get<i64>(istr.operand1));
                    break;

                case Opcode::IAbs:
                    generated_expression = make_abs<ast::primitive_kind::U64>(istr.destination);
                    break;
                case Opcode::FAbs:
                    generated_expression = make_abs<ast::primitive_kind::F32>(istr.destination);
                    break;
                ...
                case Opcode::CastInteger:
                    generated_expression = make_cast<i32>(istr, make_type_from_prim(ast::primitive_kind::I32));
                    break;
                case Opcode::CastFloat:
                    generated_expression = make_cast<f32>(istr, make_type_from_prim(ast::primitive_kind::F32));
                    break;
                ...
                case Opcode::LoadFloat:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::F32}));
                    break;
                case Opcode::LoadI32:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::I32}));
                    break;
                case Opcode::LoadU64:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::U64}));
                    break;
                case Opcode::LoadU8:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::U8}));
                    break;
                case Opcode::LoadU32:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::U32}));
                    break;
                case Opcode::LoadU16:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::U16}));
                    break;
                case Opcode::LoadI64:
                    generated_expression = std::make_unique<ast::dereference_expr>(make_cast<u64>(istr, ast::ptr_type{ast::primitive_kind::I64}));
                    break;
                case Opcode::LoadPointer:
                    generated_expression = apply_unary_op<ast::dereference_expr>(istr);
                    break;

                case Opcode::StoreU8:
                    generated_expression = make_store<ast::primitive_kind::U8>(istr);
                    break;
                case Opcode::StoreI8:
                    generated_expression = make_store<ast::primitive_kind::I8>(istr);
                    break;
                case Opcode::StoreU16:
                    generated_expression = make_store<ast::primitive_kind::U16>(istr);
                    break;
                case Opcode::StoreI16:
                    generated_expression = make_store<ast::primitive_kind::I16>(istr);
                    break;
                case Opcode::StoreU32:
                    generated_expression = make_store<ast::primitive_kind::U32>(istr);
                    break;
                case Opcode::StoreI32:
                    generated_expression = make_store<ast::primitive_kind::I32>(istr);
                    break;
                case Opcode::StoreU64:
                    generated_expression = make_store<ast::primitive_kind::U64>(istr);
                    break;
                case Opcode::StoreI64:
                case Opcode::StoreInt:
                    generated_expression = make_store<ast::primitive_kind::I64>(istr);
                    break;
                case Opcode::StoreFloat:
                    generated_expression = make_store<ast::primitive_kind::F32>(istr);
                    break;
    ...
    [[nodiscard]] expr_uptr decomp_function::make_loop_condition(
        const node_id head_start,
        const node_id head_end,
        const node_id loop_entry,
        const node_id loop_exit
    ) {
    ...
    void decomp_function::emit_branch(
        ast::block& else_block,
        const node_id target,
        const node_id idom,
        reg_set regs_to_emit,
        std::unordered_map<reg_idx, ast::full_type>& regs_to_type
    ) {
    ...
    void decomp_function::load_expression_into_existing_var(
        const reg_idx dst,
        std::unique_ptr<ast::identifier>&& var
    ) {
    ...
    [[nodiscard]] expr_uptr decomp_function::make_cast(const Instruction& istr, const ast::full_type& type) {
        ...
        if (!old_lit) {
            ...
            return std::visit(
                [&type, &old_lit](auto&& arg) -> expr_uptr {
