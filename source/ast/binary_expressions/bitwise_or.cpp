...
namespace dconstruct::ast {
    ...
    [[nodiscard]] semantic_check_res bitwise_or_expr::compute_type_checked(compilation::scope& env) const noexcept {
        ...
        const errmsg invalid_bitwise_or = std::visit(
    ...
    [[nodiscard]] resstr<reg_idx> bitwise_or_expr::emit_dc(
        ...
        const resstr<reg_idx> or_destination = fn.fix_destination(destination);
        if (!or_destination) {
