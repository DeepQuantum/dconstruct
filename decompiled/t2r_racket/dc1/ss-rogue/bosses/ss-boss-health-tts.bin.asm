...
#   listing for file: .\game_dumps\t2r\dc1\ss-rogue\bosses\ss-boss-health-tts.bin                  #
...
ss-accessbility-boss-health-tts--speak-health-percent = script-lambda [0x00078] {
    [1 args]
    ...
    0003   0x0000E0   4A 03 02 00   LoadStaticU64Imm     r3, 2         r3 = ST[2] -> <tts-health-frames>
    0004   0x0000E8   4A 04 03 00   LoadStaticU64Imm     r4, 3         r4 = ST[3] -> <self>
    0005   0x0000F0   43 31 03 00   Move                 r49, r3       r49 = tts-health-frames
    0006   0x0000F8   43 32 04 00   Move                 r50, r4       r50 = self
    0007   0x000100   1C 02 02 02   CallFf               r2, r2, 2     r2 = get-symbol(tts-health-frames, self)
    ...
    000C   0x000128   30 01 01 00   OpLogNot             r1, r1        r1 = !4013010305452811590
    ...
    0011   0x000150   4A 04 02 00   LoadStaticU64Imm     r4, 2         r4 = ST[2] -> <tts-health-frames>
    0012   0x000158   4A 05 03 00   LoadStaticU64Imm     r5, 3         r5 = ST[3] -> <self>
    0013   0x000160   43 31 04 00   Move                 r49, r4       r49 = tts-health-frames
    0014   0x000168   43 32 05 00   Move                 r50, r5       r50 = self
    0015   0x000170   1C 03 03 02   CallFf               r3, r3, 2     r3 = get-symbol(tts-health-frames, self)
  ...
  L_9:
    ...
    0020   0x0001C8   4A 05 02 00   LoadStaticU64Imm     r5, 2         r5 = ST[2] -> <tts-health-frames>
    0021   0x0001D0   4A 06 03 00   LoadStaticU64Imm     r6, 3         r6 = ST[3] -> <self>
    0022   0x0001D8   43 31 05 00   Move                 r49, r5       r49 = tts-health-frames
    0023   0x0001E0   43 32 06 00   Move                 r50, r6       r50 = self
    0024   0x0001E8   1C 04 04 02   CallFf               r4, r4, 2     r4 = get-symbol(tts-health-frames, self)
    ...
    002D   0x000230   3B 04 04 0C   IAddImm              r4, r4, 12    r4 = [RET_darray-at + 0] + 12 -> <[RET_darray-at + 12]>
    002E   0x000238   4E 04 04 00   LoadU16              r4, [r4]      r4 = *(u16*)[RET_darray-at + 12]
  ...
  L_2:
    ...
    003A   0x000298   3B 04 04 0C   IAddImm              r4, r4, 12    r4 = [RET_darray-at + 0] + 12 -> <[RET_darray-at + 12]>
    003B   0x0002A0   4E 04 04 00   LoadU16              r4, [r4]      r4 = *(u16*)[RET_darray-at + 12]
  ...
  L_4:
    ...
    0047   0x000300   3B 04 04 0C   IAddImm              r4, r4, 12    r4 = [RET_darray-at + 0] + 12 -> <[RET_darray-at + 12]>
    0048   0x000308   4E 04 04 00   LoadU16              r4, [r4]      r4 = *(u16*)[RET_darray-at + 12]
  ...
  L_5:
    ...
    0054   0x000368   3B 04 04 0C   IAddImm              r4, r4, 12    r4 = [RET_darray-at + 0] + 12 -> <[RET_darray-at + 12]>
    0055   0x000370   4E 04 04 00   LoadU16              r4, [r4]      r4 = *(u16*)[RET_darray-at + 12]
  ...
  L_6:
    ...
    0061   0x0003D0   3B 04 04 0C   IAddImm              r4, r4, 12    r4 = [RET_darray-at + 0] + 12 -> <[RET_darray-at + 12]>
    0062   0x0003D8   4E 04 04 00   LoadU16              r4, [r4]      r4 = *(u16*)[RET_darray-at + 12]
  ...
  L_7:
    ...
    006E   0x000438   3B 04 04 0C   IAddImm              r4, r4, 12    r4 = [RET_darray-at + 0] + 12 -> <[RET_darray-at + 12]>
    006F   0x000440   4E 04 04 00   LoadU16              r4, [r4]      r4 = *(u16*)[RET_darray-at + 12]
  ...
  L_1:
    ...
    008A   0x000518   4A 03 02 00   LoadStaticU64Imm     r3, 2         r3 = ST[2] -> <tts-health-frames>
    008B   0x000520   4A 04 03 00   LoadStaticU64Imm     r4, 3         r4 = ST[3] -> <self>
    008C   0x000528   43 31 03 00   Move                 r49, r3       r49 = tts-health-frames
    008D   0x000530   43 32 04 00   Move                 r50, r4       r50 = self
    008E   0x000538   1C 02 02 02   CallFf               r2, r2, 2     r2 = get-symbol(tts-health-frames, self)
  ...
  L_10:
    ...
    00AB   0x000620   19 07 07 00   CastInteger          r7            r7 = int(r7)
    ...
    0002   0x000760    sid: tts-health-frames
...
ss-accessbility-boss-health-tts = state-script [0x007E0] {
  ...
  DECLARATIONS: 
    ...
    [0x0012B8] float    cur-hp-percent       = 0.00
    [0x0012C8] boolean  allow-hp-percent-update? = true
    [0x000E58] boolean  full-health-alert-allowed? = uninitialized
    [0x000E88] boolean  should-full-health-alert? = uninitialized
    [0x000EB8] boolean  full-health-alert-triggered? = uninitialized
    [0x0012D8] boolean  half-health-alert-allowed? = true
    [0x000F18] boolean  should-half-health-alert? = uninitialized
    [0x000F48] boolean  half-health-alert-triggered? = uninitialized
    [0x0012E8] boolean  quarter-health-alert-allowed? = true
    [0x000FA8] boolean  should-quarter-health-alert? = uninitialized
    [0x000FD8] boolean  quarter-health-alert-triggered? = uninitialized
    [0x001008] timer    timer-last-tts-timer = uninitialized
    [0x0012F8] float    timer-last-tts-cooldown = 2.00
    [0x001068] symbol   tts-health-frames    = uninitialized
    STATE --script-- {
      ON start {
        TRACK main {
          {
            0000   0x003570   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <set-symbol>
            0001   0x003578   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <tts-health-frames>
            ...
            000B   0x0035C8   43 31 01 00   Move                 r49, r1       r49 = tts-health-frames
            000C   0x0035D0   43 32 02 00   Move                 r50, r2       r50 = RET_darray-create
            000D   0x0035D8   43 33 03 00   Move                 r51, r3       r51 = self
            000E   0x0035E0   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-symbol(tts-health-frames, RET_darray-create, self)
            000F   0x0035E8   00 00 00 00   Return               r0            Return 

            SYMBOL TABLE: 
            0000   0x0035F0    function: set-symbol
            0001   0x0035F8    sid: tts-health-frames
      ...
      ON event refresh-boss-hp-tts {
        TRACK main {
          {
            0000   0x003470   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <ss-accessbility-boss-health-tts--refresh-status>
            0001   0x003478   1B 00 00 00   Call                 r0, r0, 0     r0 = ss-accessbility-boss-health-tts--refresh-status()
            0002   0x003480   00 00 00 00   Return               r0            Return 

            SYMBOL TABLE: 
            0000   0x003488    function: ss-accessbility-boss-health-tts--refresh-status
          }
        }
        ...
        TRACK main {
          {
            ...
            0002   0x002FA0   4A 02 02 00   LoadStaticU64Imm     r2, 2         r2 = ST[2] -> <tts-health-frames>
            0003   0x002FA8   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            0004   0x002FB0   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
            0005   0x002FB8   43 32 03 00   Move                 r50, r3       r50 = self
            0006   0x002FC0   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
            ...
            0010   0x003010   4A 03 02 00   LoadStaticU64Imm     r3, 2         r3 = ST[2] -> <tts-health-frames>
            0011   0x003018   4A 04 03 00   LoadStaticU64Imm     r4, 3         r4 = ST[3] -> <self>
            0012   0x003020   43 31 03 00   Move                 r49, r3       r49 = tts-health-frames
            0013   0x003028   43 32 04 00   Move                 r50, r4       r50 = self
            0014   0x003030   1C 02 02 02   CallFf               r2, r2, 2     r2 = get-symbol(tts-health-frames, self)
          ...
          L_9:
            ...
            001F   0x003088   4A 04 02 00   LoadStaticU64Imm     r4, 2         r4 = ST[2] -> <tts-health-frames>
            0020   0x003090   4A 05 03 00   LoadStaticU64Imm     r5, 3         r5 = ST[3] -> <self>
            0021   0x003098   43 31 04 00   Move                 r49, r4       r49 = tts-health-frames
            0022   0x0030A0   43 32 05 00   Move                 r50, r5       r50 = self
            0023   0x0030A8   1C 03 03 02   CallFf               r3, r3, 2     r3 = get-symbol(tts-health-frames, self)
          ...
          L_1:
            ...
            0089   0x0033D8   4A 02 02 00   LoadStaticU64Imm     r2, 2         r2 = ST[2] -> <tts-health-frames>
            008A   0x0033E0   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            008B   0x0033E8   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
            008C   0x0033F0   43 32 03 00   Move                 r50, r3       r50 = self
            008D   0x0033F8   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
          ...
          L_RETURN:
            ...
            0002   0x003438    sid: tts-health-frames
      ...
      ON update {
        TRACK main {
          ...
          }
          {
            ...
            0001   0x002A48   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <cur-hp-percent>
            ...
            000C   0x002AA0   43 31 01 00   Move                 r49, r1       r49 = cur-hp-percent
            000D   0x002AA8   43 32 02 00   Move                 r50, r2       r50 = RET_get-object-health-percentage
            000E   0x002AB0   43 33 03 00   Move                 r51, r3       r51 = self
            000F   0x002AB8   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-float(cur-hp-percent, RET_get-object-health-percentage, self)
            0010   0x002AC0   00 00 00 00   Return               r0            Return 

            SYMBOL TABLE: 
            0000   0x002AC8    function: set-float
            0001   0x002AD0    sid: cur-hp-percent
          ...
          }
          {
            ...
            0007   0x002098   4A 01 02 00   LoadStaticU64Imm     r1, 2         r1 = ST[2] -> <timer-last-tts-timer>
            0008   0x0020A0   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0009   0x0020A8   43 31 01 00   Move                 r49, r1       r49 = timer-last-tts-timer
            000A   0x0020B0   43 32 02 00   Move                 r50, r2       r50 = self
            000B   0x0020B8   1B 00 00 02   Call                 r0, r0, 2     r0 = timer-running?(timer-last-tts-timer, self)
            ...
            000F   0x0020D8   4A 01 05 00   LoadStaticU64Imm     r1, 5         r1 = ST[5] -> <allow-hp-percent-update?>
            0010   0x0020E0   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0011   0x0020E8   43 31 01 00   Move                 r49, r1       r49 = allow-hp-percent-update?
            0012   0x0020F0   43 32 02 00   Move                 r50, r2       r50 = self
            0013   0x0020F8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: allow-hp-percent-update?, location: self)
            ...
            0016   0x002110   4A 01 06 00   LoadStaticU64Imm     r1, 6         r1 = ST[6] -> <quarter-health-alert-triggered?>
            0017   0x002118   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0018   0x002120   43 31 01 00   Move                 r49, r1       r49 = quarter-health-alert-triggered?
            0019   0x002128   43 32 02 00   Move                 r50, r2       r50 = self
            001A   0x002130   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: quarter-health-alert-triggered?, location: self)
            ...
            001E   0x002150   4A 01 08 00   LoadStaticU64Imm     r1, 8         r1 = ST[8] -> <cur-hp-percent>
            001F   0x002158   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0020   0x002160   43 31 01 00   Move                 r49, r1       r49 = cur-hp-percent
            0021   0x002168   43 32 02 00   Move                 r50, r2       r50 = self
            0022   0x002170   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-float(cur-hp-percent, self)
            ...
            0027   0x002198   4A 01 0B 00   LoadStaticU64Imm     r1, 11        r1 = ST[11] -> <should-quarter-health-alert?>
            0028   0x0021A0   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0029   0x0021A8   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            002A   0x0021B0   43 31 01 00   Move                 r49, r1       r49 = should-quarter-health-alert?
            002B   0x0021B8   43 32 02 00   Move                 r50, r2       r50 = 1
            002C   0x0021C0   43 33 03 00   Move                 r51, r3       r51 = self
            002D   0x0021C8   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(should-quarter-health-alert?, 1, self)
            002E   0x0021D0   2D 64 00 00   Branch               0x64          GOTO => L_3
          L_2:
            002F   0x0021D8   15 00 04 00   LookupPointer        r0, 4         r0 = ST[4] -> <get-boolean>
            0030   0x0021E0   4A 01 0C 00   LoadStaticU64Imm     r1, 12        r1 = ST[12] -> <half-health-alert-triggered?>
            0031   0x0021E8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0032   0x0021F0   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-triggered?
            0033   0x0021F8   43 32 02 00   Move                 r50, r2       r50 = self
            0034   0x002200   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: half-health-alert-triggered?, location: self)
            ...
            0038   0x002220   4A 01 08 00   LoadStaticU64Imm     r1, 8         r1 = ST[8] -> <cur-hp-percent>
            0039   0x002228   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            003A   0x002230   43 31 01 00   Move                 r49, r1       r49 = cur-hp-percent
            003B   0x002238   43 32 02 00   Move                 r50, r2       r50 = self
            003C   0x002240   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-float(cur-hp-percent, self)
            ...
            0041   0x002268   4A 01 0E 00   LoadStaticU64Imm     r1, 14        r1 = ST[14] -> <should-half-health-alert?>
            0042   0x002270   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0043   0x002278   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            0044   0x002280   43 31 01 00   Move                 r49, r1       r49 = should-half-health-alert?
            0045   0x002288   43 32 02 00   Move                 r50, r2       r50 = 1
            0046   0x002290   43 33 03 00   Move                 r51, r3       r51 = self
            0047   0x002298   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(should-half-health-alert?, 1, self)
            0048   0x0022A0   2D 64 00 00   Branch               0x64          GOTO => L_3
          L_4:
            0049   0x0022A8   15 00 04 00   LookupPointer        r0, 4         r0 = ST[4] -> <get-boolean>
            004A   0x0022B0   4A 01 0F 00   LoadStaticU64Imm     r1, 15        r1 = ST[15] -> <full-health-alert-triggered?>
            004B   0x0022B8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            004C   0x0022C0   43 31 01 00   Move                 r49, r1       r49 = full-health-alert-triggered?
            004D   0x0022C8   43 32 02 00   Move                 r50, r2       r50 = self
            004E   0x0022D0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: full-health-alert-triggered?, location: self)
            ...
            0052   0x0022F0   4A 01 08 00   LoadStaticU64Imm     r1, 8         r1 = ST[8] -> <cur-hp-percent>
            0053   0x0022F8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0054   0x002300   43 31 01 00   Move                 r49, r1       r49 = cur-hp-percent
            0055   0x002308   43 32 02 00   Move                 r50, r2       r50 = self
            0056   0x002310   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-float(cur-hp-percent, self)
            ...
            005B   0x002338   4A 01 11 00   LoadStaticU64Imm     r1, 17        r1 = ST[17] -> <should-full-health-alert?>
            005C   0x002340   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            005D   0x002348   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            005E   0x002350   43 31 01 00   Move                 r49, r1       r49 = should-full-health-alert?
            005F   0x002358   43 32 02 00   Move                 r50, r2       r50 = 1
            0060   0x002360   43 33 03 00   Move                 r51, r3       r51 = self
            0061   0x002368   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(should-full-health-alert?, 1, self)
          ...
          L_3:
            ...
            0065   0x002388   4A 01 12 00   LoadStaticU64Imm     r1, 18        r1 = ST[18] -> <quarter-health-alert-allowed?>
            0066   0x002390   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0067   0x002398   43 31 01 00   Move                 r49, r1       r49 = quarter-health-alert-allowed?
            0068   0x0023A0   43 32 02 00   Move                 r50, r2       r50 = self
            0069   0x0023A8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: quarter-health-alert-allowed?, location: self)
            ...
            006C   0x0023C0   4A 01 0B 00   LoadStaticU64Imm     r1, 11        r1 = ST[11] -> <should-quarter-health-alert?>
            006D   0x0023C8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            006E   0x0023D0   43 31 01 00   Move                 r49, r1       r49 = should-quarter-health-alert?
            006F   0x0023D8   43 32 02 00   Move                 r50, r2       r50 = self
            0070   0x0023E0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: should-quarter-health-alert?, location: self)
            ...
            0073   0x0023F8   4A 01 06 00   LoadStaticU64Imm     r1, 6         r1 = ST[6] -> <quarter-health-alert-triggered?>
            0074   0x002400   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            0075   0x002408   43 31 01 00   Move                 r49, r1       r49 = quarter-health-alert-triggered?
            0076   0x002410   43 32 02 00   Move                 r50, r2       r50 = self
            0077   0x002418   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: quarter-health-alert-triggered?, location: self)
            ...
            007C   0x002440   4A 02 15 00   LoadStaticU64Imm     r2, 21        r2 = ST[21] -> <tts-health-frames>
            007D   0x002448   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            007E   0x002450   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
            007F   0x002458   43 32 03 00   Move                 r50, r3       r50 = self
            0080   0x002460   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
            0081   0x002468   15 02 16 00   LookupPointer        r2, 22        r2 = ST[22] -> <new-boxed-value>
            0082   0x002470   0C 03 05 00   LoadU16Imm           r3, 5         r3 = 5
            0083   0x002478   15 04 17 00   LookupPointer        r4, 23        r4 = ST[23] -> <ss-accessbility-boss-health-tts--speak-health-percent>
            0084   0x002480   40 05 09 00   LoadStaticFloatImm   r5, 9         r5 = ST[9] -> <0.250000>
            0085   0x002488   43 31 05 00   Move                 r49, r5       r49 = 0.250000
            0086   0x002490   1B 04 04 01   Call                 r4, r4, 1     r4 = ss-accessbility-boss-health-tts--speak-health-percent(0.250000)
            0087   0x002498   43 31 03 00   Move                 r49, r3       r49 = 5
            0088   0x0024A0   43 32 04 00   Move                 r50, r4       r50 = RET_ss-accessbility-boss-health-tts--speak-health-percent
            0089   0x0024A8   1C 02 02 02   CallFf               r2, r2, 2     r2 = new-boxed-value(5, RET_ss-accessbility-boss-health-tts--speak-health-percent)
            ...
            0090   0x0024E0   4A 01 06 00   LoadStaticU64Imm     r1, 6         r1 = ST[6] -> <quarter-health-alert-triggered?>
            0091   0x0024E8   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0092   0x0024F0   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            0093   0x0024F8   43 31 01 00   Move                 r49, r1       r49 = quarter-health-alert-triggered?
            0094   0x002500   43 32 02 00   Move                 r50, r2       r50 = 1
            0095   0x002508   43 33 03 00   Move                 r51, r3       r51 = self
            0096   0x002510   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(quarter-health-alert-triggered?, 1, self)
            0097   0x002518   15 00 04 00   LookupPointer        r0, 4         r0 = ST[4] -> <get-boolean>
            0098   0x002520   4A 01 0C 00   LoadStaticU64Imm     r1, 12        r1 = ST[12] -> <half-health-alert-triggered?>
            0099   0x002528   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            009A   0x002530   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-triggered?
            009B   0x002538   43 32 02 00   Move                 r50, r2       r50 = self
            009C   0x002540   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: half-health-alert-triggered?, location: self)
            ...
            00A0   0x002560   4A 01 0C 00   LoadStaticU64Imm     r1, 12        r1 = ST[12] -> <half-health-alert-triggered?>
            00A1   0x002568   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            00A2   0x002570   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            00A3   0x002578   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-triggered?
            00A4   0x002580   43 32 02 00   Move                 r50, r2       r50 = 1
            00A5   0x002588   43 33 03 00   Move                 r51, r3       r51 = self
            00A6   0x002590   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(half-health-alert-triggered?, 1, self)
          ...
          L_6:
            ...
            00AC   0x0025C0   4A 01 18 00   LoadStaticU64Imm     r1, 24        r1 = ST[24] -> <half-health-alert-allowed?>
            00AD   0x0025C8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            00AE   0x0025D0   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-allowed?
            00AF   0x0025D8   43 32 02 00   Move                 r50, r2       r50 = self
            00B0   0x0025E0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: half-health-alert-allowed?, location: self)
            ...
            00B3   0x0025F8   4A 01 0E 00   LoadStaticU64Imm     r1, 14        r1 = ST[14] -> <should-half-health-alert?>
            00B4   0x002600   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            00B5   0x002608   43 31 01 00   Move                 r49, r1       r49 = should-half-health-alert?
            00B6   0x002610   43 32 02 00   Move                 r50, r2       r50 = self
            00B7   0x002618   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: should-half-health-alert?, location: self)
            ...
            00BA   0x002630   4A 01 0C 00   LoadStaticU64Imm     r1, 12        r1 = ST[12] -> <half-health-alert-triggered?>
            00BB   0x002638   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            00BC   0x002640   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-triggered?
            00BD   0x002648   43 32 02 00   Move                 r50, r2       r50 = self
            00BE   0x002650   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: half-health-alert-triggered?, location: self)
            ...
            00C3   0x002678   4A 02 15 00   LoadStaticU64Imm     r2, 21        r2 = ST[21] -> <tts-health-frames>
            00C4   0x002680   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            00C5   0x002688   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
            00C6   0x002690   43 32 03 00   Move                 r50, r3       r50 = self
            00C7   0x002698   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
            00C8   0x0026A0   15 02 16 00   LookupPointer        r2, 22        r2 = ST[22] -> <new-boxed-value>
            00C9   0x0026A8   0C 03 05 00   LoadU16Imm           r3, 5         r3 = 5
            00CA   0x0026B0   15 04 17 00   LookupPointer        r4, 23        r4 = ST[23] -> <ss-accessbility-boss-health-tts--speak-health-percent>
            00CB   0x0026B8   40 05 0D 00   LoadStaticFloatImm   r5, 13        r5 = ST[13] -> <0.500000>
            00CC   0x0026C0   43 31 05 00   Move                 r49, r5       r49 = 0.500000
            00CD   0x0026C8   1B 04 04 01   Call                 r4, r4, 1     r4 = ss-accessbility-boss-health-tts--speak-health-percent(0.500000)
            00CE   0x0026D0   43 31 03 00   Move                 r49, r3       r49 = 5
            00CF   0x0026D8   43 32 04 00   Move                 r50, r4       r50 = RET_ss-accessbility-boss-health-tts--speak-health-percent
            00D0   0x0026E0   1C 02 02 02   CallFf               r2, r2, 2     r2 = new-boxed-value(5, RET_ss-accessbility-boss-health-tts--speak-health-percent)
            ...
            00D7   0x002718   4A 01 0C 00   LoadStaticU64Imm     r1, 12        r1 = ST[12] -> <half-health-alert-triggered?>
            00D8   0x002720   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            00D9   0x002728   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            00DA   0x002730   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-triggered?
            00DB   0x002738   43 32 02 00   Move                 r50, r2       r50 = 1
            00DC   0x002740   43 33 03 00   Move                 r51, r3       r51 = self
            00DD   0x002748   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(half-health-alert-triggered?, 1, self)
            00DE   0x002750   2D 14 00 01   Branch               0x118         GOTO => L_RETURN
          L_10:
            00DF   0x002758   15 00 04 00   LookupPointer        r0, 4         r0 = ST[4] -> <get-boolean>
            00E0   0x002760   4A 01 19 00   LoadStaticU64Imm     r1, 25        r1 = ST[25] -> <full-health-alert-allowed?>
            00E1   0x002768   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            00E2   0x002770   43 31 01 00   Move                 r49, r1       r49 = full-health-alert-allowed?
            00E3   0x002778   43 32 02 00   Move                 r50, r2       r50 = self
            00E4   0x002780   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: full-health-alert-allowed?, location: self)
            ...
            00E7   0x002798   4A 01 11 00   LoadStaticU64Imm     r1, 17        r1 = ST[17] -> <should-full-health-alert?>
            00E8   0x0027A0   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            00E9   0x0027A8   43 31 01 00   Move                 r49, r1       r49 = should-full-health-alert?
            00EA   0x0027B0   43 32 02 00   Move                 r50, r2       r50 = self
            00EB   0x0027B8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: should-full-health-alert?, location: self)
            ...
            00EE   0x0027D0   4A 01 0F 00   LoadStaticU64Imm     r1, 15        r1 = ST[15] -> <full-health-alert-triggered?>
            00EF   0x0027D8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
            00F0   0x0027E0   43 31 01 00   Move                 r49, r1       r49 = full-health-alert-triggered?
            00F1   0x0027E8   43 32 02 00   Move                 r50, r2       r50 = self
            00F2   0x0027F0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: full-health-alert-triggered?, location: self)
            ...
            00F7   0x002818   4A 02 15 00   LoadStaticU64Imm     r2, 21        r2 = ST[21] -> <tts-health-frames>
            00F8   0x002820   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            00F9   0x002828   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
            00FA   0x002830   43 32 03 00   Move                 r50, r3       r50 = self
            00FB   0x002838   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
            00FC   0x002840   15 02 16 00   LookupPointer        r2, 22        r2 = ST[22] -> <new-boxed-value>
            00FD   0x002848   0C 03 05 00   LoadU16Imm           r3, 5         r3 = 5
            00FE   0x002850   15 04 17 00   LookupPointer        r4, 23        r4 = ST[23] -> <ss-accessbility-boss-health-tts--speak-health-percent>
            00FF   0x002858   40 05 10 00   LoadStaticFloatImm   r5, 16        r5 = ST[16] -> <1.000000>
            0100   0x002860   43 31 05 00   Move                 r49, r5       r49 = 1.000000
            0101   0x002868   1B 04 04 01   Call                 r4, r4, 1     r4 = ss-accessbility-boss-health-tts--speak-health-percent(1.000000)
            0102   0x002870   43 31 03 00   Move                 r49, r3       r49 = 5
            0103   0x002878   43 32 04 00   Move                 r50, r4       r50 = RET_ss-accessbility-boss-health-tts--speak-health-percent
            0104   0x002880   1C 02 02 02   CallFf               r2, r2, 2     r2 = new-boxed-value(5, RET_ss-accessbility-boss-health-tts--speak-health-percent)
            ...
            010B   0x0028B8   4A 01 0F 00   LoadStaticU64Imm     r1, 15        r1 = ST[15] -> <full-health-alert-triggered?>
            010C   0x0028C0   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            010D   0x0028C8   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            010E   0x0028D0   43 31 01 00   Move                 r49, r1       r49 = full-health-alert-triggered?
            010F   0x0028D8   43 32 02 00   Move                 r50, r2       r50 = 1
            0110   0x0028E0   43 33 03 00   Move                 r51, r3       r51 = self
            0111   0x0028E8   1C 00 00 03   CallFf               r0, r0, 3     r0 = set-boolean(full-health-alert-triggered?, 1, self)
          ...
          L_RETURN:
            ...
            0002   0x002938    sid: timer-last-tts-timer
            0003   0x002940    sid: self
            0004   0x002948    function: get-boolean(sid, sid) -> bool
            0005   0x002950    sid: allow-hp-percent-update?
            0006   0x002958    sid: quarter-health-alert-triggered?
            0007   0x002960    function: get-float
            0008   0x002968    sid: cur-hp-percent
            0009   0x002970    float: 0.250000
            000A   0x002978    function: set-boolean
            000B   0x002980    sid: should-quarter-health-alert?
            000C   0x002988    sid: half-health-alert-triggered?
            000D   0x002990    float: 0.500000
            000E   0x002998    sid: should-half-health-alert?
            000F   0x0029A0    sid: full-health-alert-triggered?
            0010   0x0029A8    float: 1.000000
            0011   0x0029B0    sid: should-full-health-alert?
            0012   0x0029B8    sid: quarter-health-alert-allowed?
            0013   0x0029C0    function: darray-append
            0014   0x0029C8    function: get-symbol
            0015   0x0029D0    sid: tts-health-frames
            0016   0x0029D8    function: new-boxed-value
            0017   0x0029E0    function: ss-accessbility-boss-health-tts--speak-health-percent
            0018   0x0029E8    sid: half-health-alert-allowed?
            0019   0x0029F0    sid: full-health-alert-allowed?
          }
          {
            ...
            0004   0x001BC8   4A 04 02 00   LoadStaticU64Imm     r4, 2         r4 = ST[2] -> <tts-health-frames>
            0005   0x001BD0   4A 05 03 00   LoadStaticU64Imm     r5, 3         r5 = ST[3] -> <self>
            0006   0x001BD8   43 31 04 00   Move                 r49, r4       r49 = tts-health-frames
            0007   0x001BE0   43 32 05 00   Move                 r50, r5       r50 = self
            0008   0x001BE8   1C 03 03 02   CallFf               r3, r3, 2     r3 = get-symbol(tts-health-frames, self)
          ...
          L_10:
            ...
            0013   0x001C40   4A 05 02 00   LoadStaticU64Imm     r5, 2         r5 = ST[2] -> <tts-health-frames>
            0014   0x001C48   4A 06 03 00   LoadStaticU64Imm     r6, 3         r6 = ST[3] -> <self>
            0015   0x001C50   43 31 05 00   Move                 r49, r5       r49 = tts-health-frames
            0016   0x001C58   43 32 06 00   Move                 r50, r6       r50 = self
            0017   0x001C60   1C 04 04 02   CallFf               r4, r4, 2     r4 = get-symbol(tts-health-frames, self)
          ...
          L_RETURN:
            ...
            0002   0x002020    sid: tts-health-frames
      ...
      ON start {
        TRACK main {
          ...
          L_12:
            ...
            0004   0x002B18   4A 04 02 00   LoadStaticU64Imm     r4, 2         r4 = ST[2] -> <tts-health-frames>
            0005   0x002B20   4A 05 03 00   LoadStaticU64Imm     r5, 3         r5 = ST[3] -> <self>
            0006   0x002B28   43 31 04 00   Move                 r49, r4       r49 = tts-health-frames
            0007   0x002B30   43 32 05 00   Move                 r50, r5       r50 = self
            0008   0x002B38   1C 03 03 02   CallFf               r3, r3, 2     r3 = get-symbol(tts-health-frames, self)
          ...
          L_10:
            ...
            0013   0x002B90   4A 05 02 00   LoadStaticU64Imm     r5, 2         r5 = ST[2] -> <tts-health-frames>
            0014   0x002B98   4A 06 03 00   LoadStaticU64Imm     r6, 3         r6 = ST[3] -> <self>
            0015   0x002BA0   43 31 05 00   Move                 r49, r5       r49 = tts-health-frames
            0016   0x002BA8   43 32 06 00   Move                 r50, r6       r50 = self
            0017   0x002BB0   1C 04 04 02   CallFf               r4, r4, 2     r4 = get-symbol(tts-health-frames, self)
          ...
          L_RETURN:
            ...
            0002   0x002F58    sid: tts-health-frames
          ...
          }
          {
            ...
            0001   0x001AC0   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <timer-last-tts-timer>
            0002   0x001AC8   15 02 02 00   LookupPointer        r2, 2         r2 = ST[2] -> <get-float>
            0003   0x001AD0   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <timer-last-tts-cooldown>
            0004   0x001AD8   4A 04 04 00   LoadStaticU64Imm     r4, 4         r4 = ST[4] -> <self>
            0005   0x001AE0   43 31 03 00   Move                 r49, r3       r49 = timer-last-tts-cooldown
            0006   0x001AE8   43 32 04 00   Move                 r50, r4       r50 = self
            0007   0x001AF0   1C 02 02 02   CallFf               r2, r2, 2     r2 = get-float(timer-last-tts-cooldown, self)
            0008   0x001AF8   4A 03 04 00   LoadStaticU64Imm     r3, 4         r3 = ST[4] -> <self>
            0009   0x001B00   0C 04 01 00   LoadU16Imm           r4, 1         r4 = 1
            000A   0x001B08   43 31 01 00   Move                 r49, r1       r49 = timer-last-tts-timer
            ...
            000E   0x001B28   1B 00 00 04   Call                 r0, r0, 4     r0 = start-timer(timer-last-tts-timer, RET_get-float, self, 1)
            000F   0x001B30   00 00 00 00   Return               r0            Return 

            SYMBOL TABLE: 
            0000   0x001B38    function: start-timer
            0001   0x001B40    sid: timer-last-tts-timer
            0002   0x001B48    function: get-float
            0003   0x001B50    sid: timer-last-tts-cooldown
          ...
          }
          {
            ...
            0002   0x003510   4A 02 02 00   LoadStaticU64Imm     r2, 2         r2 = ST[2] -> <tts-health-frames>
            0003   0x003518   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
            0004   0x003520   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
            0005   0x003528   43 32 03 00   Move                 r50, r3       r50 = self
            0006   0x003530   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
            ...
            0002   0x003560    sid: tts-health-frames
...
ss-accessbility-boss-health-tts--refresh-status = script-lambda [0x00838] {
    ...
    000B   0x0008E0   4A 01 05 00   LoadStaticU64Imm     r1, 5         r1 = ST[5] -> <quarter-health-alert-triggered?>
    000C   0x0008E8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
    000D   0x0008F0   43 31 01 00   Move                 r49, r1       r49 = quarter-health-alert-triggered?
    000E   0x0008F8   43 32 02 00   Move                 r50, r2       r50 = self
    000F   0x000900   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: quarter-health-alert-triggered?, location: self)
    ...
    0013   0x000920   4A 02 07 00   LoadStaticU64Imm     r2, 7         r2 = ST[7] -> <tts-health-frames>
    0014   0x000928   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
    0015   0x000930   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
    0016   0x000938   43 32 03 00   Move                 r50, r3       r50 = self
    0017   0x000940   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
    0018   0x000948   15 02 08 00   LookupPointer        r2, 8         r2 = ST[8] -> <new-boxed-value>
    0019   0x000950   0C 03 05 00   LoadU16Imm           r3, 5         r3 = 5
    001A   0x000958   15 04 09 00   LookupPointer        r4, 9         r4 = ST[9] -> <ss-accessbility-boss-health-tts--speak-health-percent>
    001B   0x000960   40 05 0A 00   LoadStaticFloatImm   r5, 10        r5 = ST[10] -> <0.250000>
    001C   0x000968   43 31 05 00   Move                 r49, r5       r49 = 0.250000
    001D   0x000970   1B 04 04 01   Call                 r4, r4, 1     r4 = ss-accessbility-boss-health-tts--speak-health-percent(0.250000)
    001E   0x000978   43 31 03 00   Move                 r49, r3       r49 = 5
    001F   0x000980   43 32 04 00   Move                 r50, r4       r50 = RET_ss-accessbility-boss-health-tts--speak-health-percent
    0020   0x000988   1C 02 02 02   CallFf               r2, r2, 2     r2 = new-boxed-value(5, RET_ss-accessbility-boss-health-tts--speak-health-percent)
  ...
  L_1:
    ...
    0028   0x0009C8   4A 01 0B 00   LoadStaticU64Imm     r1, 11        r1 = ST[11] -> <half-health-alert-triggered?>
    0029   0x0009D0   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
    002A   0x0009D8   43 31 01 00   Move                 r49, r1       r49 = half-health-alert-triggered?
    002B   0x0009E0   43 32 02 00   Move                 r50, r2       r50 = self
    002C   0x0009E8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: half-health-alert-triggered?, location: self)
    ...
    0030   0x000A08   4A 02 07 00   LoadStaticU64Imm     r2, 7         r2 = ST[7] -> <tts-health-frames>
    0031   0x000A10   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
    0032   0x000A18   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
    0033   0x000A20   43 32 03 00   Move                 r50, r3       r50 = self
    0034   0x000A28   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
    0035   0x000A30   15 02 08 00   LookupPointer        r2, 8         r2 = ST[8] -> <new-boxed-value>
    0036   0x000A38   0C 03 05 00   LoadU16Imm           r3, 5         r3 = 5
    0037   0x000A40   15 04 09 00   LookupPointer        r4, 9         r4 = ST[9] -> <ss-accessbility-boss-health-tts--speak-health-percent>
    0038   0x000A48   40 05 0C 00   LoadStaticFloatImm   r5, 12        r5 = ST[12] -> <0.500000>
    0039   0x000A50   43 31 05 00   Move                 r49, r5       r49 = 0.500000
    003A   0x000A58   1B 04 04 01   Call                 r4, r4, 1     r4 = ss-accessbility-boss-health-tts--speak-health-percent(0.500000)
    003B   0x000A60   43 31 03 00   Move                 r49, r3       r49 = 5
    003C   0x000A68   43 32 04 00   Move                 r50, r4       r50 = RET_ss-accessbility-boss-health-tts--speak-health-percent
    003D   0x000A70   1C 02 02 02   CallFf               r2, r2, 2     r2 = new-boxed-value(5, RET_ss-accessbility-boss-health-tts--speak-health-percent)
  ...
  L_3:
    ...
    0045   0x000AB0   4A 01 0D 00   LoadStaticU64Imm     r1, 13        r1 = ST[13] -> <full-health-alert-triggered?>
    0046   0x000AB8   4A 02 03 00   LoadStaticU64Imm     r2, 3         r2 = ST[3] -> <self>
    0047   0x000AC0   43 31 01 00   Move                 r49, r1       r49 = full-health-alert-triggered?
    0048   0x000AC8   43 32 02 00   Move                 r50, r2       r50 = self
    0049   0x000AD0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(symbol: full-health-alert-triggered?, location: self)
    ...
    004D   0x000AF0   4A 02 07 00   LoadStaticU64Imm     r2, 7         r2 = ST[7] -> <tts-health-frames>
    004E   0x000AF8   4A 03 03 00   LoadStaticU64Imm     r3, 3         r3 = ST[3] -> <self>
    004F   0x000B00   43 31 02 00   Move                 r49, r2       r49 = tts-health-frames
    0050   0x000B08   43 32 03 00   Move                 r50, r3       r50 = self
    0051   0x000B10   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-symbol(tts-health-frames, self)
    0052   0x000B18   15 02 08 00   LookupPointer        r2, 8         r2 = ST[8] -> <new-boxed-value>
    0053   0x000B20   0C 03 05 00   LoadU16Imm           r3, 5         r3 = 5
    0054   0x000B28   15 04 09 00   LookupPointer        r4, 9         r4 = ST[9] -> <ss-accessbility-boss-health-tts--speak-health-percent>
    0055   0x000B30   40 05 0E 00   LoadStaticFloatImm   r5, 14        r5 = ST[14] -> <1.000000>
    0056   0x000B38   43 31 05 00   Move                 r49, r5       r49 = 1.000000
    0057   0x000B40   1B 04 04 01   Call                 r4, r4, 1     r4 = ss-accessbility-boss-health-tts--speak-health-percent(1.000000)
    0058   0x000B48   43 31 03 00   Move                 r49, r3       r49 = 5
    0059   0x000B50   43 32 04 00   Move                 r50, r4       r50 = RET_ss-accessbility-boss-health-tts--speak-health-percent
    005A   0x000B58   1C 02 02 02   CallFf               r2, r2, 2     r2 = new-boxed-value(5, RET_ss-accessbility-boss-health-tts--speak-health-percent)
  ...
  L_RETURN:
    ...
    0005   0x000BD8    sid: quarter-health-alert-triggered?
    0006   0x000BE0    function: darray-append
    0007   0x000BE8    sid: tts-health-frames
    0008   0x000BF0    function: new-boxed-value
    0009   0x000BF8    function: ss-accessbility-boss-health-tts--speak-health-percent
    000A   0x000C00    float: 0.250000
    000B   0x000C08    sid: half-health-alert-triggered?
    000C   0x000C10    float: 0.500000
    000D   0x000C18    sid: full-health-alert-triggered?
