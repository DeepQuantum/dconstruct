...
#   listing for file: ...ain/bin_unpacked/dc1\ss-santa-barbara\ss-vox-san-streets-resort-pool.bin  #
...
ss-vox-san-streets-resort-pool = state-script [0x000D8] {
  statescript #ss-vox-san-streets-resort-pool {
    options {
      #player
    }
    declarations {
      ...
      #vox-see-farm-done
      #vox-near-gate-done
      #vox-pool-combat-done
      #vox-see-pool-done
      #vox-landing-combat-done
      #vox-near-pool-encounter
      #vox-player-outisde
      #vox-first-search-start-played
    }
    state task-check {
      block start {
        track main {
          lambda task-check@start@main@0 {
            ...
            0006   0x003DE0   2F 1A 00 00   BranchIfNot          r0, 0x1A      IF NOT r0 
            ...
            0019   0x003E78   2D 1B 00 00   Branch               0x1B          GOTO 
    ...
    state wait-for-event {
      ...
      block event npc-died {
        track main {
          lambda wait-for-event@event_npc-died@main@0 {
            ...
            0005   0x002CB0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(vox-pool-combat-done, self)
            0006   0x002CB8   30 00 00 00   OpLogNot             r0, r0        r0 = !RET_get-boolean
            0007   0x002CC0   2F 30 00 00   BranchIfNot          r0, 0x30      IF NOT r0 
            ...
            000C   0x002CE8   2F 0F 00 00   BranchIfNot          r0, 0x2E      IF NOT r0 
            ...
            000F   0x002D00   2F 1E 00 00   BranchIfNot          r0, 0x2E      IF NOT r0 
            ...
            001E   0x002D78   2F 2E 00 00   BranchIfNot          r0, 0x2E      IF NOT r0 
            ...
            002D   0x002DF0   2D 2F 00 00   Branch               0x31          GOTO 
            002E   0x002DF8   0C 00 00 00   LoadU16Imm           r0, 0         r0 = 0
            002F   0x002E00   2D 31 00 00   Branch               0x31          GOTO 
          ...
          lambda wait-for-event@event_npc-died@main@1 {
            ...
            0005   0x002970   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(vox-landing-combat-done, self)
            0006   0x002978   30 00 00 00   OpLogNot             r0, r0        r0 = !RET_get-boolean
            0007   0x002980   2F 30 00 00   BranchIfNot          r0, 0x30      IF NOT r0 
            ...
            000C   0x0029A8   2F 0F 00 00   BranchIfNot          r0, 0x2E      IF NOT r0 
            ...
            000F   0x0029C0   2F 1E 00 00   BranchIfNot          r0, 0x2E      IF NOT r0 
            ...
            001E   0x002A38   2F 2E 00 00   BranchIfNot          r0, 0x2E      IF NOT r0 
            ...
            002D   0x002AB0   2D 2F 00 00   Branch               0x31          GOTO 
            002E   0x002AB8   0C 00 00 00   LoadU16Imm           r0, 0         r0 = 0
            002F   0x002AC0   2D 31 00 00   Branch               0x31          GOTO 
      ...
      block event player-draw-weapon-done {
        track main {
          lambda wait-for-event@event_player-draw-weapon-done@main@0 {
            ...
            0005   0x0031E8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(vox-see-pool-done, self)
            0006   0x0031F0   30 00 00 00   OpLogNot             r0, r0        r0 = !RET_get-boolean
            0007   0x0031F8   2F 17 00 00   BranchIfNot          r0, 0x17      IF NOT r0 
            ...
            0016   0x003270   2D 18 00 00   Branch               0x18          GOTO 
            0017   0x003278   0C 00 00 00   LoadU16Imm           r0, 0         r0 = 0
            0018   0x003280   00 00 00 00   Return               r0            Return 
          }
        }
      }
      block event vox-san-pool-search-start {
        track main {
          lambda wait-for-event@event_vox-san-pool-search-start@main@0 {
            ...
            0006   0x003A48   1C 01 01 02   CallFf               r1, r1, 2     r1 = get-boolean(vox-first-search-start-played, self)
            0007   0x003A50   43 31 01 00   Move                 r49, r1       r49 = RET_get-boolean
            0008   0x003A58   1B 00 00 01   Call                 r0, r0, 1     r0 = !(RET_get-boolean)
            0009   0x003A60   2F 10 00 00   BranchIfNot          r0, 0x23      IF NOT r0 
            ...
            000F   0x003A90   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(vox-player-outisde, self)
            0010   0x003A98   2F 13 00 00   BranchIfNot          r0, 0x23      IF NOT r0 
            ...
            0013   0x003AB0   2F 23 00 00   BranchIfNot          r0, 0x23      IF NOT r0 
      ...
      block event vox-landing-spawn {
        track main {
          lambda wait-for-event@event_vox-landing-spawn@main@0 {
            ...
            0005   0x0036E0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(vox-first-search-start-played, self)
            0006   0x0036E8   2F 18 00 00   BranchIfNot          r0, 0x18      IF NOT r0 
            ...
            0017   0x003770   2D 28 00 00   Branch               0x28          GOTO 
    ...
    state see-building {
      block start {
        ...
        track timeout {
          lambda see-building@start@timeout@0 {
          ...
          lambda see-building@start@timeout@1 {
            ...
            0007   0x003408   2F 0F 00 00   BranchIfNot          r0, 0xF       IF NOT r0 
            ...
            000E   0x003440   2D 10 00 00   Branch               0x10          GOTO 
      ...
      block event tension-changed {
        track main {
          lambda see-building@event_tension-changed@main@0 {
            0000   0x0035C8   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <go>
            0001   0x0035D0   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <wait-for-event>
            0002   0x0035D8   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0003   0x0035E0   43 31 01 00   Move                 r49, r1       r49 = wait-for-event
    ...
    state land-in-pool-area {
      block start {
        track main {
          lambda land-in-pool-area@start@main@0 {
            ...
            0005   0x003378   2F 0B 00 00   BranchIfNot          r0, 0xB       IF NOT r0 
            ...
            000A   0x0033A0   2D 00 00 00   Branch               0x0           GOTO 
            000B   0x0033A8   00 00 00 00   Return               r0            Return 
          }
          lambda land-in-pool-area@start@main@1 {
            0000   0x002788   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <wait>
            0001   0x002790   40 01 01 00   LoadStaticFloatImm   r1, 1         r1 = ST[1] -> <0.500000>
            0002   0x002798   43 31 01 00   Move                 r49, r1       r49 = 0.500000
            0003   0x0027A0   1C 00 00 01   CallFf               r0, r0, 1     r0 = wait(0.500000)
          ...
          lambda land-in-pool-area@start@main@2 {
          ...
          lambda land-in-pool-area@start@main@3 {
          ...
          lambda land-in-pool-area@start@main@4 {
          ...
          lambda land-in-pool-area@start@main@5 {
            0000   0x0035C8   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <go>
            0001   0x0035D0   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <wait-for-event>
            0002   0x0035D8   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0003   0x0035E0   43 31 01 00   Move                 r49, r1       r49 = wait-for-event
    ...
    state dinner-convo {
      block start {
        track main {
          lambda dinner-convo@start@main@0 {
            ...
            0004   0x002888   2F 0D 00 00   BranchIfNot          r0, 0xF       IF NOT r0 
            ...
            000E   0x0028D8   2F 14 00 00   BranchIfNot          r0, 0x14      IF NOT r0 
            ...
            0013   0x002900   2D 00 00 00   Branch               0x0           GOTO 
            0014   0x002908   00 00 00 00   Return               r0            Return 
          }
          lambda dinner-convo@start@main@1 {
            ...
            0006   0x003F80   2E 0D 00 00   BranchIf             r0, 0x20      IF r0 
            ...
            000E   0x003FC0   2F 20 00 00   BranchIfNot          r0, 0x20      IF NOT r0 
      ...
      block event tension-changed {
        track main {
          lambda dinner-convo@event_tension-changed@main@0 {
            0000   0x0035C8   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <go>
            0001   0x0035D0   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <wait-for-event>
            0002   0x0035D8   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0003   0x0035E0   43 31 01 00   Move                 r49, r1       r49 = wait-for-event
    ...
    state pool-combat-done {
      block start {
        track main {
          lambda pool-combat-done@start@main@0 {
            ...
            0005   0x002EA0   2F 0A 01 00   BranchIfNot          r1, 0xA       IF NOT r1 
            ...
            0009   0x002EC0   2D 0B 00 00   Branch               0xB           GOTO 
            ...
            0015   0x002F20   2F 2F 02 00   BranchIfNot          r2, 0x2F      IF NOT r2 
            ...
            002E   0x002FE8   2D 4D 00 00   Branch               0x4D          GOTO 
            ...
            0032   0x003008   2F 4C 02 00   BranchIfNot          r2, 0x4C      IF NOT r2 
            ...
            004B   0x0030D0   2D 4D 00 00   Branch               0x4D          GOTO 
          ...
          lambda pool-combat-done@start@main@1 {
          ...
          lambda pool-combat-done@start@main@2 {
          ...
          lambda pool-combat-done@start@main@3 {
          ...
          lambda pool-combat-done@start@main@4 {
            0000   0x004088   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <wait>
            0001   0x004090   40 01 01 00   LoadStaticFloatImm   r1, 1         r1 = ST[1] -> <0.300000>
            0002   0x004098   43 31 01 00   Move                 r49, r1       r49 = 0.300000
            0003   0x0040A0   1C 00 00 01   CallFf               r0, r0, 1     r0 = wait(0.300000)
          ...
          lambda pool-combat-done@start@main@5 {
          ...
          lambda pool-combat-done@start@main@6 {
            0000   0x002788   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <wait>
            0001   0x002790   40 01 01 00   LoadStaticFloatImm   r1, 1         r1 = ST[1] -> <0.500000>
            0002   0x002798   43 31 01 00   Move                 r49, r1       r49 = 0.500000
            0003   0x0027A0   1C 00 00 01   CallFf               r0, r0, 1     r0 = wait(0.500000)
          ...
          lambda pool-combat-done@start@main@7 {
          ...
          lambda pool-combat-done@start@main@8 {
            0000   0x0035C8   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <go>
            0001   0x0035D0   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <wait-for-event>
            0002   0x0035D8   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0003   0x0035E0   43 31 01 00   Move                 r49, r1       r49 = wait-for-event
    ...
    state landing-combat-done {
      block start {
        track main {
          lambda landing-combat-done@start@main@0 {
          ...
          lambda landing-combat-done@start@main@1 {
          ...
          lambda landing-combat-done@start@main@2 {
          ...
          lambda landing-combat-done@start@main@3 {
          ...
          lambda landing-combat-done@start@main@4 {
          ...
          lambda landing-combat-done@start@main@5 {
            ...
            0002   0x0032C8   2F 0C 00 00   BranchIfNot          r0, 0xC       IF NOT r0 
    ...
    state first-search-start {
      block start {
        track main {
          lambda first-search-start@start@main@0 {
          ...
          lambda first-search-start@start@main@1 {
            0000   0x0035C8   15 00 00 00   LookupPointer        r0, 0         r0 = ST[0] -> <go>
            0001   0x0035D0   4A 01 01 00   LoadStaticU64Imm     r1, 1         r1 = ST[1] -> <wait-for-event>
            0002   0x0035D8   0C 02 01 00   LoadU16Imm           r2, 1         r2 = 1
            0003   0x0035E0   43 31 01 00   Move                 r49, r1       r49 = wait-for-event
