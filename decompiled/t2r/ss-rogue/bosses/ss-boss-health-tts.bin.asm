...
#   listing for file: ...II/build/pc/main/bin_unpacked/dc1\ss-rogue\bosses\ss-boss-health-tts.bin  #
...
ss-accessbility-boss-health-tts = state-script [0x007E0] {
  statescript #ss-accessbility-boss-health-tts {
    ...
    declarations {
      ...
      #name
      #cur-hp-percent
      #allow-hp-percent-update?
      #full-health-alert-allowed?
      #should-full-health-alert?
      #full-health-alert-triggered?
      #half-health-alert-allowed?
      #should-half-health-alert?
      #half-health-alert-triggered?
      #quarter-health-alert-allowed?
      #should-quarter-health-alert?
      #quarter-health-alert-triggered?
      #timer-last-tts-timer
      #timer-last-tts-cooldown
      #tts-health-frames
    }
    state --script-- {
      block start {
      ...
      block event refresh-boss-hp-tts {
        track main {
          lambda --script--@event_refresh-boss-hp-tts@main@0 {
      ...
      block update {
        track main {
          ...
          lambda tracking@update@main@2 {
            ...
            0013   0x0020F8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(allow-hp-percent-update?, self)
            ...
            001A   0x002130   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(quarter-health-alert-triggered?, self)
            ...
            0034   0x002200   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(half-health-alert-triggered?, self)
            ...
            004E   0x0022D0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(full-health-alert-triggered?, self)
            ...
            0069   0x0023A8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(quarter-health-alert-allowed?, self)
            ...
            0070   0x0023E0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(should-quarter-health-alert?, self)
            ...
            0077   0x002418   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(quarter-health-alert-triggered?, self)
            ...
            009C   0x002540   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(half-health-alert-triggered?, self)
            ...
            00B0   0x0025E0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(half-health-alert-allowed?, self)
            ...
            00B7   0x002618   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(should-half-health-alert?, self)
            ...
            00BE   0x002650   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(half-health-alert-triggered?, self)
            ...
            00E4   0x002780   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(full-health-alert-allowed?, self)
            ...
            00EB   0x0027B8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(should-full-health-alert?, self)
            ...
            00F2   0x0027F0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(full-health-alert-triggered?, self)
...
ss-accessbility-boss-health-tts--refresh-status = script-lambda [0x00838] {
    ...
    000F   0x000900   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(quarter-health-alert-triggered?, self)
    ...
    002C   0x0009E8   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(half-health-alert-triggered?, self)
    ...
    0049   0x000AD0   1C 00 00 02   CallFf               r0, r0, 2     r0 = get-boolean(full-health-alert-triggered?, self)
