...
namespace dconstruct {
    ...
    const char* UP_Instruction<padding>::opcode_to_string() const noexcept {
        switch (opcode) {
            ...
            case Opcode::LoadStaticInt:
                return "LoadStaticInt";
            case Opcode::LoadStaticFloat:
                return "LoadStaticFloat";
            case Opcode::LoadStaticPointer:
                return "LoadStaticPointer";
    ...
    [[nodiscard]] bool UP_Instruction<padding>::destination_is_immediate() const noexcept {
        return opcode == Opcode::Branch || opcode == Opcode::BranchIf || opcode == Opcode::BranchIfNot || opcode == Opcode::Return || opcode == Opcode::AssertPointer;
    }
    template <u8 padding>
    [[nodiscard]] bool UP_Instruction<padding>::operand1_is_immediate() const noexcept {
        return opcode == Opcode::LoadStaticI32Imm || opcode == Opcode::LoadStaticI16Imm || opcode == Opcode::LoadStaticU16Imm || opcode == Opcode::LoadStaticI8Imm || opcode == Opcode::LoadStaticU8Imm || opcode == Opcode::LoadStaticU32Imm || opcode == Opcode::LoadStaticI64Imm || opcode == Opcode::LoadStaticU64Imm || opcode == Opcode::LoadStaticFloatImm || opcode == Opcode::LoadStaticPointer || opcode == Opcode::LoadStaticPointerImm || opcode == Opcode::LoadU16Imm || opcode == Opcode::LookupPointer;
    }
    template <u8 padding>
    [[nodiscard]] bool UP_Instruction<padding>::operand2_is_immediate() const noexcept {
        return opcode == Opcode::Call || opcode == Opcode::CallFf || opcode == Opcode::IAddImm || opcode == Opcode::IMulImm || opcode == Opcode::ISubImm || opcode == Opcode::IDivImm || opcode == Opcode::LoadU16Imm || opcode == Opcode::QEX_InRangeI;
    }
    template <u8 padding>
...
#undef max
    ...
    struct StackFrame {
        ...
        StackFrame(location symbol_table = location(nullptr)) noexcept :
            m_registers{}, m_symbolTable{symbol_table, {}} {
