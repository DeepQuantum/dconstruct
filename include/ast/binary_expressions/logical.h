...
namespace dconstruct::ast {
    struct logical_expr : public clonable_binary_expr<logical_expr> {
        ...
        [[nodiscard]] condition_branch_res emit_dc_branch(compilation::function_context& fn, compilation::global_state& global, bool branch_when_true) const noexcept final;
