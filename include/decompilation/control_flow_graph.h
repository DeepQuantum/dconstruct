...
namespace dconstruct {
    ...
    struct control_flow_node {
        ...
        reg_set m_readFirstTwiceRegs = 0;
        ...
        [[nodiscard]] std::pair<reg_set, reg_set> get_read_count_starting_at(const istr_line start_line) const noexcept;
    };
    ...
    public:
        ...
        u8 get_register_read_count(const control_flow_node& start_node, const reg_idx reg_to_check, const node_id stop_node, const istr_line start_line = 0) const noexcept;
