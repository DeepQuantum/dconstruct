...
namespace dconstruct {
    ...
    public:
        ...
        [[nodiscard]] void get_variant_registers_recursive(const node_id node, std::set<u32>& read_after_regs, std::set<u32>& written_to_regs, u32 start_line = 0) const noexcept;
